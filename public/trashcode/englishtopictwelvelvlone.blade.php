...
@section('title', 'Positive, Comparative, and Superlative Degree | Level 1 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">HE IS THE <u>SMARTEST</u> STUDENT IN CLASS.
  ...
  <div class="div-choices1">
    ...
    <button class="choice" onclick="showCircle('blue')">Beautiful</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopictwelvelvltwo";
    }
