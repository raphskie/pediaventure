...
@section('back-link', 'englishtopicninelevels')
@section('title', 'Fact or Opinion | Level 7 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">EAGLES ARE BIGGER THAN COMMON BIRDS.
    </h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">Fact</button>
    <button class="choice" onclick="showCircle('red')">Opinion</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicninelvleight";
    }
