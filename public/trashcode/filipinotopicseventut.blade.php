...
@section('title', 'Panghalip Panao | PEDIAVENTURE')
...
<div class="container-login" 
    ...
    <p class="p-tutorial">Para sa pag-aaral ng Panghalip Panao
        sa asignaturang Filipino, maaaring basahin ang katanungan sa itaas at piliin ang tamang sagot na nasa 
        ibaba nito.</p>

    <a href="filipinotopicsevenlevels" class="home-log-reg" style="
        width: 46%;
        margin-left: auto;
        margin-right: auto;
    ">MAGPATULOY</a>   
