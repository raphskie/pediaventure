...
@section('title', 'Compound Words | Level 1 English | PEDIAVENTURE')
...
">
    ...
    ">The students are all sitting quietly.</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">The butterfly is flying around the garden</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">The men are buying cars in the shop.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicsixlvltwo";
    }
