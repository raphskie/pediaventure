...
@section('title', 'Mass Noun and Count Noun | Level 8 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THEY ARE ARE DRINKING <u>WATER</u>.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopictwolvlnine";
    }
