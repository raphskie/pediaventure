...
@section('title', 'Nouns | Level 10 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">JOSE AND AMEALIA WANT TO GO TO FRANCE SOMEDAY.
      WHICH OF THE FOLLOWING IS THE NOUN IN THE SENTENCE?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">FRANCE</button>
    <button class="choice" onclick="showCircle('red')">WANT</button>
    <button class="choice" onclick="showCircle('red')">SOMEDAY</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopiconelevels";
    }
