...
@section('title', 'Panghalip Pananong | Antas 2 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    KAILAN TAYO MAGSASALO-SALO?
    ALIN SA PAGPILIAN ANG NAGSASAAD NG KATANUNGAN?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">KAILAN</button>
    <button class="choice" onclick="showCircle('red')">MAGSASALO-SALO</button>
    <button class="choice" onclick="showCircle('red')">TAYO</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopiceightlvlthree";
    }
