...
@section('title', 'Mass Noun and Count Noun | Level 7 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE <u>SPEED</u> OF HIS CAR IS AMAZING.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopictwolvleight";
    }
