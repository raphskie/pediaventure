...
@section('title', 'Pangatnig | Antas 7 Filipino | PEDIAVENTURE')
...
">
    ...
    ">Ang mga tao ay naglalakad sa hardin.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Isa siyang estudyante.</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Siya ay naglilinis upang mawala ang mga dumi.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicfifteenlvleight";
    }
