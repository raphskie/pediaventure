...
@section('title', 'Pang-ukol | Antas 6 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ANG SABI NI JOSE KAY AMELIA AY BIBILI SIYA NG PAGKAIN.
    ALIN ANG NAGSASAAD NG PANG-UKOL SA PANGUNGUSAP?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Bibili</button>
    <button class="choice" onclick="showCircle('blue')">Kay</button>
    <button class="choice" onclick="showCircle('red')">Pagkain</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicthirteenlvlseven";
    }
