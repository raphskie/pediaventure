...
@section('title', 'Nouns | Level 1 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">MR. GONZALES IS TEACHING ENGLISH TO HIS STUDENTS TODAY.
      WHICH OF THE FOLLOWING IS THE NOUN IN THE SENTENCE?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">TO</button>
    <button class="choice" onclick="showCircle('red')">TODAY</button>
    <button class="choice" onclick="showCircle('blue')">MR. GONZALES</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopiconelvltwo";
    }
