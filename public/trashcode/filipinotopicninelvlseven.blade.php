...
@section('back-link', 'filipinotopicninelevels')
@section('title', 'Pandiwa | Antas 7 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    SILA AY SUMASAYAW SA HARAPAN NG MARAMING TAO SA PAARALAN.
    ALIN SA PAGPILIAN ANG NAGSASAAD NG KILOS O GALAW?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">PAARALAN</button>
    <button class="choice" onclick="showCircle('red')">TAO</button>
    <button class="choice" onclick="showCircle('blue')">SUMASAYAW</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicninelvleight";
    }
