...
@section('title', 'Singular and Plural | Level 2 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE <u>DOGS</u> ARE ALL PLAYING TOGETHER IN THE PARK.
    WHAT DOES THE COLORED WORD EXPRESS?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Singular</button>
    <button class="choice" onclick="showCircle('blue')">Plural</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicfourlvlthree";
    }
