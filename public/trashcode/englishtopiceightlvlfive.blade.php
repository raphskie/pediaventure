...
@section('title', 'Identifying the Subject and Predicate | Level 5 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE RED MOON RARELY APPEARS.
...
">
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopiceightlvlsix";
    }
