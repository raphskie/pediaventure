...
@section('title', 'Patinig at Katinig | Antas 3 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    <h1 class="h1-instruction">ANG BAHAY NG AKING KAIBIGAN AY <u>MALINIS</u>. ANG NAKULAYANG SALITA AY ALIN
      SA MGA SUMUSUNOD?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Patinig</button>
    <button class="choice" onclick="showCircle('blue')">Katinig</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopictwolvlfour";
    }
