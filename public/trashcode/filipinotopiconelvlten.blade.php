...
@section('title', 'Diptonggo | Antas 10 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Bata</button>
    <button class="choice" onclick="showCircle('blue')">Atay</button>
    <button class="choice" onclick="showCircle('red')">Bitaw</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopiconelevels";
    }
