...
@section('title', 'Pandiwa | Antas 10 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    TUWING SABADO SIYA NANONOOD SA TELEBISYON.
    ALIN SA PAGPILIAN ANG NAGSASAAD NG KILOS O GALAW?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">TELEBISYON</button>
    <button class="choice" onclick="showCircle('blue')">NANONOOD</button>
    <button class="choice" onclick="showCircle('red')">SABADO</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicninelevels";
    }
