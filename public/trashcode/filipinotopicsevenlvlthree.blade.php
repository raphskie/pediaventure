...
@section('title', 'Panghalip Panao | Antas 3 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <u>AKO</u> AY ISANG ESTUDYANTE.
    ANG NAKULAYANG SALITA AY NAGSASAAD NG...</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">ISAHAN</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicsevenlvlfour";
    }
