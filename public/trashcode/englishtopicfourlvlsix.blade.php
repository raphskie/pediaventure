...
@section('title', 'Singular and Plural | Level 6 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">PHILIPPINES HAS A LOT OF <u>ISLANDS</u>.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicfourlvlseven";
    }
