...
@section('title', 'Identifying the Subject and Predicate | Level 8 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE DOG IS EATING ITS FOOD.
...
">
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopiceightlvlnine";
    }
