...
@section('title', 'Compound Words | Level 3 English | PEDIAVENTURE')
...
">
    ...
    ">The rain has watered her plants.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">It is raining heavily here.</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">A rainbow has appeared after the rain</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicsixlvlfour";
    }
