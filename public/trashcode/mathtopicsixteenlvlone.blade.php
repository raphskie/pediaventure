...
@section('title', 'Object Measurement | Level 1 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE LENGTH OF A PENCIL IS 17 CENTIMETERS. IF ANOTHER 17-CENTIMETER PENCIL IS LINED-UP,
    WHAT IS THE TOTAL LENGTH?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">36</button>
    <button class="choice" onclick="showCircle('red')">32</button>
    <button class="choice" onclick="showCircle('blue')">34</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicsixteenlvltwo";
    }
