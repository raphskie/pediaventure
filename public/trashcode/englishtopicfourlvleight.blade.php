...
@section('title', 'Singular and Plural | Level 8 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">WHAT DOES THOSE <u>WORDS</u> MEAN?
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicfourlvlnine";
    }
