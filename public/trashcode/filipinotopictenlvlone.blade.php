...
@section('title', 'Pang-uri | Antas 1 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ANG KANIYANG LAKAD AY MABILIS.
    ANO ANG NAGSASAAD NG PANG-URI SA PANGUNGUSAP?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">LAKAD</button>
    <button class="choice" onclick="showCircle('red')">KANIYANG</button>
    <button class="choice" onclick="showCircle('blue')">MABILIS</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopictenlvltwo";
    }
