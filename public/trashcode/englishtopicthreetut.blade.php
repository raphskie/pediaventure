...
@section('title', 'Common and Proper Noun | PEDIAVENTURE')
...
<div class="container-login" 
    ...
    <div class="topic-flex">    
        <p class="p-tutorial">You will be determining whether the colored noun is a name or not in
        the question above. Choose the correct answer below. You can do it, adventurer!</p>

        <a href="englishtopicthreelevels" class="home-log-reg" style="
            width: 46%;
            margin-left: auto;
            margin-right: auto;
        ">PROCEED</a>    
