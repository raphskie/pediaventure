...
@section('title', 'Capitalization of Words | Level 10 English | PEDIAVENTURE')
...
">
    ...
    ">How many oreos are you going to Eat?</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">How many oreos are you Going to eat?</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicseventeenlevels";
    }
