...
@section('back-link', 'englishtopicfourteenlevels')
@section('title', 'Subject Verb Agreement and Verb Phrase | Level 7 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE WORKERS ARE MOVING THE TABLE OUTSIDE THE ROOM.
    WHERE IS THE SUBJECT IN THE SENTENCE?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">The workers</button>
    <button class="choice" onclick="showCircle('red')">Moving</button>
    <button class="choice" onclick="showCircle('red')">Outside</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicfourteenlvleight";
    }
