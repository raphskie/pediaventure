...
@section('title', 'Diptonggo | Antas 1 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="div-choices1">
    ...
    <button class="choice" onclick="showCircle('blue')">Sabaw</button>
    <button class="choice" onclick="showCircle('red')">Apoy</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopiconelvltwo";
    }
