...
@section('title', 'Rounding-Off | Level 7 Math | PEDIAVENTURE')
...
">
    <h1 class="h1-instruction" style="
        ...
        line-height: 36px;
        font-weight: 100;
    ">ROUND-OFF 264 TO THE NEAREST TEN.</h1>
  </div>
  ...
  <div class="div-choices3 float1">
    ...
    <button class="balloon-choice" onclick="showCircle('blue')">300</button>
  ...
  <div class="div-choices3 float1">
    ...
    function nextLevel() {
      window.location.href = "mathtopicfivelvleight";
    }
  </script>
