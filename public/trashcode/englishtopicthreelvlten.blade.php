...
@section('title', 'Common Noun and Proper Noun | Level 10 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction"><u>BORACAY</u> IS A VERY GREAT BEACH.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicthreelevels";
    }
