...
@section('title', 'Wastong Paggalang, Pagbati, Pakiki-usap, at Paghingi ng Paumanhin | Antas 4 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    SA IYONG SALO-SALO, NAKITA MO ANG IYONG MATALIK NA PINSAN NA MATAGAL MO NANG HINDI NAKIKITA.
    ALIN ANG WASTONG PANGUNGUSAP PARA DITO?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">HOY!</button>
    <button class="choice" onclick="showCircle('blue')">KAMUSTA NA PO KAYO, KUYA/ATE?</button>
    <button class="choice" onclick="showCircle('red')">AYAW KO SA KANYA.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicsixlvlfive";
    }
