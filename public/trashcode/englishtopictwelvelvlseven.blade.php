...
@section('title', 'Positive, Comparative, and Superlative Degree | Level 7 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THAT CAR IS <u>COOLER</u> THAN THE OTHER CAR NEXT TO IT.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopictwelvelvleight";
    }
