...
@section('title', 'Compound Words | Level 4 English | PEDIAVENTURE')
...
">
    ...
    ">How much is this?</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">The diver saw a lot of jellyfishes underwater.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">The man wants to surf around.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicsixlvlfive";
    }
