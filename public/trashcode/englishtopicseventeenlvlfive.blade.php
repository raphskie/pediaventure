...
@section('title', 'Capitalization of Words | Level 5 English | PEDIAVENTURE')
...
">
    ...
    ">This mall has a jollibee restaurant Inside.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicseventeenlvlsix";
    }
