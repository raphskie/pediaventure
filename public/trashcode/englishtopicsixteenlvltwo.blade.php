...
@section('title', 'Syllabicating Words | Level 2 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">HOW MANY SYLLABLES DOES <u>BEAUTIFUL</u> HAVE?</h1>
  </div>
  ...
  <div class="div-choices1">
    ...
    <button class="choice" onclick="showCircle('blue')">3</button>
    <button class="choice" onclick="showCircle('red')">4</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicsixteenlvlthree";
    }
