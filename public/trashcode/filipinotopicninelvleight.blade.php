...
@section('title', 'Pandiwa | Antas 8 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ANG KANIYANG INA AY NAGLULUTO PARA SA KANIYANG KAARAAWAN.
    ALIN SA PAGPILIAN ANG NAGSASAAD NG KILOS O GALAW?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">NAGLULUTO</button>
    <button class="choice" onclick="showCircle('red')">INA</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicninelvlnine";
    }
