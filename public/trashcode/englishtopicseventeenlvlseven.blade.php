...
@section('title', 'Capitalization of Words | Level 7 English | PEDIAVENTURE')
...
">
    ...
    ">You can buy Toblerone at the grocery.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicseventeenlvleight";
    }
