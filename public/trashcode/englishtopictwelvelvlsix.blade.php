...
@section('title', 'Positive, Comparative, and Superlative Degree | Level 6 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE ENGINE IS <u>NOISY</u>.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopictwelvelvlseven";
    }
