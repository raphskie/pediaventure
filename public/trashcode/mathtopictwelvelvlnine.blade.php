...
@section('title', 'Identifying the Improper Fraction | Level 9 Math | PEDIAVENTURE')
...
@section('content')
  ...
  <div class="div-choices3 float1">
    <button class="balloon-choice" onclick="showCircle('red')">52/63</button>
    <button class="balloon-choice" onclick="showCircle('blue')">37/31</button>
    <button class="balloon-choice" onclick="showCircle('red')">56/63</button>
    <button class="balloon-choice" onclick="showCircle('red')">74/85</button>
    <button class="balloon-choice" onclick="showCircle('red')">88/96</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopictwelvelvlten";
    }
  </script>
