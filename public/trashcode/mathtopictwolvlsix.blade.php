...
@section('title', 'Standard Forms | Level 6 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">WHAT IS THE STANDARD FORM OF 20 + 20 + 20?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">20</button>
    <button class="choice" onclick="showCircle('blue')">60</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopictwolvlseven";
    }
