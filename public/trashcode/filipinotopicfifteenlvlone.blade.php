...
@section('title', 'Pangatnig | Antas 1 Filipino | PEDIAVENTURE')
...
">
    ...
    ">Siya ay kumakanta habang nag-aaral.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Ano ang iyong pangalan?</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Siya ay bumibili sa tindahan.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicfifteenlvltwo";
    }
