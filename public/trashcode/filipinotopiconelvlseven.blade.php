...
@section('title', 'Diptonggo | Antas 7 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">ALIN SA MGA SUMUSUNOD ANG MAY DIPTONGGO NA <u>"OY"</u></h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">Kahoy</button>
    <button class="choice" onclick="showCircle('red')">Kahel</button>
    <button class="choice" onclick="showCircle('red')">Kapoy</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopiconelvleight";
    }
