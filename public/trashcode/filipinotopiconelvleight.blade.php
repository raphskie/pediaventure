...
@section('title', 'Diptonggo | Antas 8 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">ALIN SA MGA SUMUSUNOD ANG MAY DIPTONGGO NA <u>"AW"</u></h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Anay</button>
    <button class="choice" onclick="showCircle('blue')">Banahaw</button>
    <button class="choice" onclick="showCircle('red')">Alay</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopiconelvlnine";
    }
