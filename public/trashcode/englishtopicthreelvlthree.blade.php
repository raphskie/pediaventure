...
@section('title', 'Common Noun and Proper Noun | Level 3 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE AUTHOR OF THE BOOK IS <u>DR. JOSE RIZAL</u>.
    WHICH OF THE FOLLOWING DOES THE COLORED WORD EXPRESSES?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Common Noun</button>
    <button class="choice" onclick="showCircle('blue')">Proper Noun</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicthreelvlfour";
    }
