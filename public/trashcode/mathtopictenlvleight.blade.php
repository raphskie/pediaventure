...
@section('title', 'Find the Quotient | Level 8 Math | PEDIAVENTURE')
...
@section('content')
  ...
  <div class="div-choices3 float2">
    ...
    <button class="balloon-choice" onclick="showCircle('blue')">10</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopictenlvlnine";
    }
  </script>
