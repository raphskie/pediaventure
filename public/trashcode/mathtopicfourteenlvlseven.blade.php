...
@section('title', 'Conversion of Time | Level 7 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">CONVERT 2 HOURS TO MINUTES.</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">130</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicfourteenlvleight";
    }
