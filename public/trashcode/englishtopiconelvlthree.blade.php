...
@section('back-link', 'englishtopiconelevels')
@section('title', 'Nouns | Level 3 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">MRS. SANTOS IS GOING TO TEACH HER STUDENTS IN THE AFTERNOON.
      WHICH OF THE FOLLOWING IS THE NOUN IN THE SENTENCE?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">MRS. SANTOS</button>
    <button class="choice" onclick="showCircle('red')">GOING</button>
    <button class="choice" onclick="showCircle('red')">HER</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopiconelvlfour";
    }
