...
@section('title', 'Rhymes | Level 1 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">WHAT RHYMES WITH "BATCH"?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">Catch</button>
    <button class="choice" onclick="showCircle('red')">Neat</button>
    <button class="choice" onclick="showCircle('red')">Not</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicsevenlvltwo";
    }
