...
@section('title', 'Wastong Paggamit ng Dayalogo | Antas 2 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    font-size: 22px;
    font-weight: lighter;
">SI AMELIA AY NAKIKIPAGLARO SA KANIYANG KALARO, NGUNIT BIGLAANG NADAPA ANG KANIYANG
      KALARO DAHIL SA PAA NI AMELIA. ANO ANG WASTONG DAYALOGO O KASABIHAN PARA DITO?
    </h1>
  </div>
  ...
  <div class="div-choices1" style="
    ...
    flex-wrap: wrap;
">
    <button class="choice2" onclick="showCircle('blue')">PASENYA NA. HINDI KO SINASADYA NA MASAKTAN KA.</button>
    <button class="choice2" onclick="showCircle('red')">ETO AY ANG PAGKAIN.</button>
    <button class="choice2" onclick="showCircle('red')">SIYA AY ISANG MABAIT NA TAO.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicfourlvlthree";
    }
