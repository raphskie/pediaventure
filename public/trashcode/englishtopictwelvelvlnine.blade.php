...
@section('title', 'Positive, Comparative, and Superlative Degree | Level 9 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">HE HAS A <u>CLEAN</u> UNIFORM.
      WHAT DEGREE OF COMPARISON DOES THE COLORED WORD EXPRESS?
    </h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">Positive</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopictwelvelvlten";
    }
