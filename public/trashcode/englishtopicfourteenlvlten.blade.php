...
@section('title', 'Subject Verb Agreement and Verb Phrase | Level 10 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE GADGETS ARE BEING RELEASED THIS MONTH.
    WHERE IS THE SUBJECT IN THE SENTENCE?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">The gadgets</button>
    <button class="choice" onclick="showCircle('red')">Being released</button>
    <button class="choice" onclick="showCircle('red')">This</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicfourteenlevels";
    }
