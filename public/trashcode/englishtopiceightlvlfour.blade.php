...
@section('back-link', 'englishtopiceightlevels')
@section('title', 'Identifying the Subject and Predicate | Level 4 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE DOG AND THE CAT ARE PLAYING TOGETHER
    WHERE IS THE PREDICATE IN THE SENTENCE?</h1>
  </div>
...
">
    ...
    ">The dog and the cat</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">are playing together</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopiceightlvlfive";
    }
