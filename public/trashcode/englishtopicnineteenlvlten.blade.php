...
@section('title', 'Prepositions | Level 10 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THAT HOUSE IS FULL OF BALLOONS, AND IT'S GOING ___.
      WHAT IS THE APPROPRIATE PREPOSITION IN THE SENTENCE?
    </h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">On</button>
    <button class="choice" onclick="showCircle('red')">Down</button>
    V<button class="choice" onclick="showCircle('blue')">Up</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicnineteenlevels";
    }
