...
@section('back-link', 'englishtopicseventeenlevels')
@section('title', 'Capitalization of Words | Level 2 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    WHICH OF THE FOLLOWING HAS A PROPER CAPITALIZATION?</h1>
  </div>
...
">
    ...
    ">Mrs. gomez is going to Her class this afternoon.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">The brand Name of that car is toyota.</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">One of the most common plasticware brands here in Philippines is Orocan.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicseventeenlvlthree";
    }
