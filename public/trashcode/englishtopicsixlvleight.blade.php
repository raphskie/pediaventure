...
@section('title', 'Compound Words | Level 8 English | PEDIAVENTURE')
...
">
    ...
    ">The bakers presented cupcakes on her birthday.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid -37px #57370a;
    ">She is going to her favorite clothing store</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">He is practicing for the contest.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicsixlvlnine";
    }
