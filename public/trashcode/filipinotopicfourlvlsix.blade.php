...
@section('title', 'Wastong Paggamit ng Dayalogo | Antas 6 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    font-size: 22px;
    font-weight: lighter;
">NAKITA MO ANG IYONG INA NA MARAMING GINAGAWA.
  ...
  <div class="div-choices1" style="
    ...
    flex-wrap: wrap;
">
    <button class="choice2" onclick="showCircle('red')">HALINA'T TULUNGAN KITA DYAN.</button>
    <button class="choice2" onclick="showCircle('red')">BAHALA KA SA BUHAY MO!</button>
    <button class="choice2" onclick="showCircle('blue')">MA, TULUNGAN NALANG PO KITA.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicfourlvlseven";
    }
