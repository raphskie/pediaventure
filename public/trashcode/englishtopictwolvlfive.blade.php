...
@section('title', 'Mass Noun and Count Noun | Level 5 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE COW <u>WEIGHS</u> MORE THAN THE MAN.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopictwolvlsix";
    }
