...
@section('title', 'Mass Noun and Count Noun | Level 3 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">HIS MOTHER IS BUYING <u>APPLES</u> AND OTHER FRUITS.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopictwolvlfour";
    }
