...
@section('title', 'Adjective  | Level 10 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THIS BOOK HAS SMALL LETTERS.
      WHERE IS THE ADJECTIVE IN THE SENTENCE?
    </h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">Small</button>
    <button class="choice" onclick="showCircle('red')">This</button>
    <button class="choice" onclick="showCircle('red')">Book</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicelevenlevels";
    }
