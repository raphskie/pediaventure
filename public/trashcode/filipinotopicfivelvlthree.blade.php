...
@section('title', 'Pantangi at Pambalana | Antas 3 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ANG <u>TOYOTA</u> AY ISA SA MGA SIKAT NA KOMPANYA.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicfivelvlfour";
    }
