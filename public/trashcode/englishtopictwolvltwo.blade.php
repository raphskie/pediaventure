...
@section('title', 'Mass Noun and Count Noun | Level 2 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">A LOT OF <u>SNOWFLAKES</u> FALL ON DECEMBER.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopictwolvlthree";
    }
