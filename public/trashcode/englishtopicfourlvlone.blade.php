...
@section('back-link', 'englishtopicfourlevels')
@section('title', 'Singular and Plural | Level 1 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE <u>MAN</u> IS WALKING ON THE SIDEWALK WITH HIS DOG.
    WHAT DOES THE COLORED WORD EXPRESS?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">Singular</button>
    <button class="choice" onclick="showCircle('red')">Plural</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicfourlvltwo";
    }
