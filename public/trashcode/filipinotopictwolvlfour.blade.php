...
@section('title', 'Patinig at Katinig | Antas 4 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    <h1 class="h1-instruction">ANG <u>OSO</u> AY NAGLALAKAD SA GUBAT. ANG NAKULAYANG SALITA AY ALIN
      SA MGA SUMUSUNOD?</h1>
  </div>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopictwolvlfive";
    }
