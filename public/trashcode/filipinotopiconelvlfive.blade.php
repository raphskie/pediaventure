...
@section('title', 'Diptonggo | Antas 5 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">Kasoy</button>
    <button class="choice" onclick="showCircle('red')">Bahay</button>
    <button class="choice" onclick="showCircle('red')">Nanay</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopiconelvlsix";
    }
