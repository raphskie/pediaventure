...
@section('back-link', 'englishtopicthirteenlevels')
@section('title', 'Order of Adjectives | Level 7 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    WHICH SENTENCE HAS A CORRECT ORDER OF ADJECTIVES?</h1>
  </div>
...
">
    ...
    ">They are studying about the hole black great.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">They are studying about the black hole great.</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">They are studying about the great black hole.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicthirteenlvleight";
    }
