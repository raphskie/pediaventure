...
@section('title', 'Find the Product | Level 4 Math | PEDIAVENTURE')
...
@section('content')
  ...
  <div class="div-choices3 float1">
    <button class="balloon-choice" onclick="showCircle('blue')">90</button>
    <button class="balloon-choice" onclick="showCircle('red')">73</button>
    <button class="balloon-choice" onclick="showCircle('red')">58</button>
    <button class="balloon-choice" onclick="showCircle('red')">95</button>
  ...
  <div class="div-choices3 float2">
    ...
    <button class="balloon-choice" onclick="showCircle('red')">12</button>
    <button class="balloon-choice" onclick="showCircle('red')">63</button>
    <button class="balloon-choice" onclick="showCircle('red')">58</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopiceightlvlfive";
    }
  </script>
