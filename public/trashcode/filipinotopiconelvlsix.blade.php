...
@section('title', 'Diptonggo | Antas 6 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">ALIN SA MGA SUMUSUNOD ANG MAY DIPTONGGO NA <u>"IW"</u></h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Agaw</button>
    <button class="choice" onclick="showCircle('red')">Kasoy</button>
    <button class="choice" onclick="showCircle('blue')">Agiw</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopiconelvlseven";
    }
