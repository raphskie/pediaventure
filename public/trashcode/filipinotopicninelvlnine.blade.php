...
@section('title', 'Pandiwa | Antas 9 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    SILA AY PUMUPUNTA SA HARDIN.
    ALIN SA PAGPILIAN ANG NAGSASAAD NG KILOS O GALAW?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">SILA</button>
    <button class="choice" onclick="showCircle('red')">HARDIN</button>
    <button class="choice" onclick="showCircle('blue')">PUMUPUNTA</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicninelvlten";
    }
