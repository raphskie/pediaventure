...
@section('title', 'Nouns | Level 8 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">A LOT OF PEOPLE LIVE IN MANILA.
      WHICH OF THE FOLLOWING IS THE NOUN IN THE SENTENCE?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">LOT</button>
    <button class="choice" onclick="showCircle('red')">LIVE</button>
    <button class="choice" onclick="showCircle('blue')">MANILA</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopiconelvlnine";
    }
