...
@section('title', 'Rhymes | Level 3 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">WHAT RHYMES WITH "RAY"?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Yacht</button>
    <button class="choice" onclick="showCircle('red')">Brick</button>
    <button class="choice" onclick="showCircle('blue')">Tray</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicsevenlvlfour";
    }
