...
@section('title', 'Panghalip Pananong | Antas 7 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="div-choices1">
    ...
    <button class="choice" onclick="showCircle('blue')">NASAAN</button>
    <button class="choice" onclick="showCircle('red')">IYONG</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopiceightlvleight";
    }
