...
@section('title', 'Identifying the Improper Fraction | Level 4 Math | PEDIAVENTURE')
...
@section('content')
  ...
  <div class="div-choices3 float1">
    <button class="balloon-choice" onclick="showCircle('red')">5/6</button>
    <button class="balloon-choice" onclick="showCircle('blue')">6/5</button>
    <button class="balloon-choice" onclick="showCircle('red')">9/12</button>
    <button class="balloon-choice" onclick="showCircle('red')">4/5</button>
    <button class="balloon-choice" onclick="showCircle('red')">3/6</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopictwelvelvlfive";
    }
  </script>
