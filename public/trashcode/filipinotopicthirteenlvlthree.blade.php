...
@section('title', 'Pang-ukol | Antas 3 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    SIYA AY NAGLAKAD MULA SA KANIYANG BAHAY.
  ...
  <div class="div-choices1">
    ...
    <button class="choice" onclick="showCircle('blue')">Mula sa</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicthirteenlvlfour";
    }
