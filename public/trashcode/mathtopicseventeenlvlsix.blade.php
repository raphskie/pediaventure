...
@section('title', 'Identifying the Standard Measurement | Level 6 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    WHAT MEASUREMENT TYPE IS USED ON A PERSON'S HEIGHT?</h1>
  </div>
...
">
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicseventeenlvlseven";
    }
