...
@section('title', 'Common Noun and Proper Noun | Level 9 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction"><u>TCL</u> IS A GOOD TELEVISION BRAND.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicthreelvlten";
    }
