...
@section('title', 'Panghalip Pananong | Antas 3 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    SINO ANG GUMAWA NG PROYEKTONG IYAN?
    ALIN SA PAGPILIAN ANG NAGSASAAD NG KATANUNGAN?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">GUMAWA</button>
    <button class="choice" onclick="showCircle('red')">IYAN</button>
    <button class="choice" onclick="showCircle('blue')">SINO</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopiceightlvlfour";
    }
