...
@section('title', 'Addition and Subtraction | Level 8 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">12 - 9 + 10 = ?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">19</button>
    <button class="choice" onclick="showCircle('blue')">13</button>
    <button class="choice" onclick="showCircle('red')">16</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicsevenlvlnine";
    }
