...
@section('title', 'Identifying the Improper Fraction | Level 10 Math | PEDIAVENTURE')
...
@section('content')
  ...
  <div class="div-choices3 float1">
    <button class="balloon-choice" onclick="showCircle('red')">141/252</button>
    <button class="balloon-choice" onclick="showCircle('red')">251/252</button>
    <button class="balloon-choice" onclick="showCircle('red')">151/226</button>
    <button class="balloon-choice" onclick="showCircle('blue')">153/123</button>
    <button class="balloon-choice" onclick="showCircle('red')">363/633</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopictwelvelevels";
    }
  </script>
