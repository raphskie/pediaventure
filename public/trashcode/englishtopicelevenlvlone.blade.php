...
@section('title', 'Adjective  | Level 1 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE GIRL IS BEAUTIFUL.
  ...
  <div class="div-choices1">
    ...
    <button class="choice" onclick="showCircle('red')">Girl</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicelevenlvltwo";
    }
