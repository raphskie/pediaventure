...
@section('title', 'Tambalang Salita | Antas 8 Filipino | PEDIAVENTURE')
...
">
    ...
    ">Ang aking matalik na kaibigan ay nagpasama sa silid-aklatan.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Siya ay nag-aaral sa huling pagsusulit.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Siya ay gumuguhit ng isang larawan.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicfourteenlvlnine";
    }
