...
@section('title', 'Pang-uring Panlarawan at Pang-uring Pamilang | Antas 2 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ANG BIGAS NA BINIBILI NI NANAY AY <u>ISANG KILO</u>.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicelevenlvlthree";
    }
