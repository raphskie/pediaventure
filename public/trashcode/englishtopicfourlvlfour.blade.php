...
@section('title', 'Singular and Plural | Level 4 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE <u>PAINTINGS</u> ARE ALL IN THE MUSEUM.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicfourlvlfive";
    }
