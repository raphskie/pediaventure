...
@section('title', 'Order of Adjectives | Level 6 English | PEDIAVENTURE')
...
">
    ...
    ">The fancy red carpet is being cleaned today.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">The carpet red fancy is being cleaned today.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">The carpet fancy red is being cleaned today.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicthirteenlvlseven";
    }
