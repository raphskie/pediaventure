...
@section('title', 'Patinig at Katinig | Antas 6 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    <h1 class="h1-instruction">SIYA AY <u>ISA</u> SA MGA ESTUDYANTE. ANG NAKULAYANG SALITA AY ALIN
      SA MGA SUMUSUNOD?</h1>
  </div>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopictwolvlseven";
    }
