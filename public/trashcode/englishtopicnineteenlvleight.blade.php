...
@section('title', 'Prepositions | Level 8 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE BOX IS IN FRONT OF THE CAT, AND IT'S HIDING ___ IT.
      WHAT IS THE APPROPRIATE PREPOSITION IN THE SENTENCE?
    </h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">Behind</button>
    <button class="choice" onclick="showCircle('red')">Across</button>
    V<button class="choice" onclick="showCircle('red')">On</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicnineteenlvlnine";
    }
