...
@section('title', 'Transitive and Intransitive Verb | Level 4 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">SHE KNOWS.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicfifteenlvlfive";
    }
