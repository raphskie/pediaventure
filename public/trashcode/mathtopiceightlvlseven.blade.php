...
@section('title', 'Find the Product | Level 7 Math | PEDIAVENTURE')
...
@section('content')
  ...
  <div class="div-choices3 float1">
    <button class="balloon-choice" onclick="showCircle('red')">14</button>
    <button class="balloon-choice" onclick="showCircle('blue')">20</button>
    <button class="balloon-choice" onclick="showCircle('red')">13</button>
    <button class="balloon-choice" onclick="showCircle('red')">16</button>
  ...
  <div class="div-choices3 float2">
    ...
    <button class="balloon-choice" onclick="showCircle('red')">31</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopiceightlvleight";
    }
  </script>
