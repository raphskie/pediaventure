...
@section('title', 'Compound Words | Level 6 English | PEDIAVENTURE')
...
">
    ...
    ">They have a lot of food in their celebration</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid -37px #57370a;
    ">The skating rink is overcrowded every December.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">She has a lot of pencil.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicsixlvlseven";
    }
