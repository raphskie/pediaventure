...
@section('title', 'Word Form of Numbers | Level 5 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    WHAT IS THE WORD FORM OF 620?</h1>
  </div>
...
">
    ...
    ">Six-hundred two zero</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Six-hundred two</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Six-hundred twenty</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicthreelvlsix";
    }
