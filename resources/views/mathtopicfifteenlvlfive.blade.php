...
@section('title', 'Time Measurement of Days, Weeks, Months, and Years | Level 5 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">HOW MANY DAYS DOES A SATURDAY TO SUNDAY HAVE?</h1>
  </div>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicfifteenlvlsix";
    }
