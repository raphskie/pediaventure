...
@section('back-link', 'filipinotopicfivelevels')
@section('title', 'Pantangi at Pambalana | Antas 7 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ANG <u>SAMSUNG</u> AY ISANG KOMPANYA NA GALING SA TIMOG NA BAHAGI NG KOREA.
    ALIN SA MGA SUMUSUNOD AY ANG NAGSASAAD SA NAKULAYANG SALITA?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">Pantangi</button>
    <button class="choice" onclick="showCircle('red')">Pambalana</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicfivelvleight";
    }
