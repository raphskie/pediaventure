...
@section('title', 'Synonyms and Antonyms | Level 2 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">What is the synonym of "Dirty"?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Neat</button>
    <button class="choice" onclick="showCircle('red')">Clean</button>
    <button class="choice" onclick="showCircle('blue')">Messy</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicfivelvlthree";
    }
