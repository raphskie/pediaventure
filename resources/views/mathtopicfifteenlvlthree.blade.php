...
@section('title', 'Time Measurement of Days, Weeks, Months, and Years | Level 3 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">HOW MANY WEEKS ARE 14 DAYS</h1>
  </div>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicfifteenlvlfour";
    }
