...
@section('title', 'Wastong Paggamit ng Dayalogo | Antas 9 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    font-size: 22px;
    font-weight: lighter;
      ">ANO ANG WASTONG DAYALOGO O KASABIHAN KAPAG IKAW AY NASAKTAN?
    </h1>
  </div>
...
">
    ...
    <button class="choice2" onclick="showCircle('red')">ANO PO ANG IYONG GINAGAWA?</button>
    <button class="choice2" onclick="showCircle('blue')">ARAY KO!</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicfourlvlten";
    }
