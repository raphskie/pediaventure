...
@section('title', 'Pang-uring Panlarawan at Pang-uring Pamilang | Antas 8 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ANG NAIS NIYANG BILHIN AY <u>ISANG DOSENANG</u> SHAMPOO.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicelevenlvlnine";
    }
