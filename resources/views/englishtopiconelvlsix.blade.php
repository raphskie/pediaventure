...
@section('title', 'Nouns | Level 6 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE BRAND OF HIS CAR IS TOYOTA.
      WHICH OF THE FOLLOWING IS THE NOUN IN THE SENTENCE?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">TOYOTA</button>
    <button class="choice" onclick="showCircle('red')">HIS</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopiconelvlseven";
    }
