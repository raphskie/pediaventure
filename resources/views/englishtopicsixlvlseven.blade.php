...
@section('back-link', 'englishtopicsixlevels')
@section('title', 'Compound Words | Level 7 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    WHICH SENTENCE HAS A COMPOUND WORD?</h1>
  </div>
...
">
    ...
    ">What present did she get?</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid -37px #57370a;
    ">He is listening to music while studying.</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">He has to wear a raincoat before going out on rainy days.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicsixlvleight";
    }
