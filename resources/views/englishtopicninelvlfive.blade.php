...
@section('title', 'Fact or Opinion | Level 5 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">PINEAPPLES SHOULD BE ON PIZZAS.
    </h1>
  </div>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicninelvlsix";
    }
