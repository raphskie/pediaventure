...
@section('title', 'Fact or Opinion | Level 8 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THIS PERFUME IS BETTER THAN THAT ONE.
    </h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Fact</button>
    <button class="choice" onclick="showCircle('blue')">Opinion</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicninelvlnine";
    }
