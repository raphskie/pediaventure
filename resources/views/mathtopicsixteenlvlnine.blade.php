...
@section('title', 'Object Measurement | Level 9 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">A MAN DELIVERED 4 GALLONS OF WATER IN JOSE'S HOUSE, IN WHICH A SINGLE
      GALLON WEIGHS ABOUT 10 POUNDS. HOW MUCH IN TOTAL DID THE MAN LIFT?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">60</button>
    <button class="choice" onclick="showCircle('red')">50</button>
    <button class="choice" onclick="showCircle('blue')">40</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicsixteenlvlten";
    }
