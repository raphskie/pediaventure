...
@section('title', 'Kaantasan ng Pang-uri | Antas 8 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ANG AKING NAKAKATANDANG KAPATID AY <u>NAPAKAHUSAY</u>.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopictwelvelvlnine";
    }
