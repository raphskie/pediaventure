...
@section('title', 'Pang-ukol | Antas 5 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    DAHIL SA KANILA, ANG SILID-ARALAN AY MULING LUMINIS.
    ALIN ANG NAGSASAAD NG PANG-UKOL SA PANGUNGUSAP?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">Dahil sa</button>
    <button class="choice" onclick="showCircle('red')">Luminis</button>
    <button class="choice" onclick="showCircle('red')">Silid-aralan</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicthirteenlvlsix";
    }
