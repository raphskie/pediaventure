...
@section('title', 'Prepositions | Level 9 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THERE'S A LOT OF CORALS ___ THE SEA.
  ...
  <div class="div-choices1">
    ...
    <button class="choice" onclick="showCircle('blue')">Under</button>
    V<button class="choice" onclick="showCircle('red')">Behind</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicnineteenlvlten";
    }
