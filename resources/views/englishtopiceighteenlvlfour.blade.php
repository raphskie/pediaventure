...
@section('title', 'Dipthongs | Level 4 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">WHAT WORD HAS A DIPTHONG "OOR"?
    </h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Poot</button>
    <button class="choice" onclick="showCircle('blue')">Poor</button>
    V<button class="choice" onclick="showCircle('red')">Loot</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopiceighteenlvlfive";
    }
