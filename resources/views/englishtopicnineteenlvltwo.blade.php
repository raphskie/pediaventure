...
@section('title', 'Prepositions | Level 2 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE ANIMALS JUMPED ___ THE HEDGE. 
      WHAT IS THE APPROPRIATE PREPOSITION IN THE SENTENCE?
    </h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Under</button>
    <button class="choice" onclick="showCircle('blue')">Over</button>
    V<button class="choice" onclick="showCircle('red')">During</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicnineteenlvlthree";
    }
