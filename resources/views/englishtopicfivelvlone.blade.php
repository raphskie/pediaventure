...
@section('title', 'Synonyms and Antonyms | Level 1 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">What is the synonym of "Beautiful"?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">Pretty</button>
    <button class="choice" onclick="showCircle('red')">Ugly</button>
    <button class="choice" onclick="showCircle('red')">Bad</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicfivelvltwo";
    }
