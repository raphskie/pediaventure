...
@section('title', 'Different Types of Sentences  | Level 2 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">DO YOU HAVE WATER IN THIS OFFICE?
    </h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Declarative</button>
    <button class="choice" onclick="showCircle('blue')">Interrogative</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopictenlvlthree";
    }
