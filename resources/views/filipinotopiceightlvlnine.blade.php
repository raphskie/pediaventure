...
@section('title', 'Panghalip Pananong | Antas 9 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    MAGKANO ANG IYONG SUKLI SA TINDAHAN?
    ALIN SA PAGPILIAN ANG NAGSASAAD NG KATANUNGAN?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">MAGKANO</button>
    <button class="choice" onclick="showCircle('red')">SUKLI</button>
    <button class="choice" onclick="showCircle('red')">TINDAHAN</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopiceightlvlten";
    }
