...
@section('title', 'Find the Quotient | Level 7 Math | PEDIAVENTURE')
...
@section('content')
  ...
  <div class="div-choices3 float1">
    <button class="balloon-choice" onclick="showCircle('blue')">6</button>
  ...
  <div class="div-choices3 float2">
    ...
    <button class="balloon-choice" onclick="showCircle('red')">11</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopictenlvleight";
    }
  </script>
