...
@section('title', 'Panghalip Pananong | Antas 5 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    GAANO KATAAS ANG PUNONG NARRA?
    ALIN SA PAGPILIAN ANG NAGSASAAD NG KATANUNGAN?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">GAANO</button>
    <button class="choice" onclick="showCircle('red')">KATAAS</button>
    <button class="choice" onclick="showCircle('red')">NARRA</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopiceightlvlsix";
    }
