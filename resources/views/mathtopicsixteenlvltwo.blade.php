...
@section('title', 'Object Measurement | Level 2 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">A FAN BLADE HAS A LENGTH OF 18 INCHES AND THERE'S A MISSING BLADE.
    WHAT SHOULD BE THE LENGTH OF THE MISSING FAN BLADE?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">19</button>
    <button class="choice" onclick="showCircle('red')">17</button>
    <button class="choice" onclick="showCircle('blue')">18</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicsixteenlvlthree";
    }
