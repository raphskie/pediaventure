...
@section('title', 'Pantangi at Pambalana | Antas 8 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ANG PANGALAN NG KANIYANG TIYUHIN AY <u>RODEL</u>.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicfivelvlnine";
    }
