...
@section('back-link', 'englishtopiceighteenlevels')
@section('title', 'Dipthongs | Level 6 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">WHAT WORD HAS A DIPTHONG "OON"?
    </h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">Spoon</button>
    <button class="choice" onclick="showCircle('red')">Mood</button>
    V<button class="choice" onclick="showCircle('red')">Pool</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopiceighteenlvlseven";
    }
