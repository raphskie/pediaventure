...
@section('title', 'Object Measurement | Level 3 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">JOSE'S DAD WANTS THE 7-LITER PAIL TO HAVE MORE 3 LITERS OF WATER. HOW
    MANY LITERS WILL THE PAIL HAVE?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">12</button>
    <button class="choice" onclick="showCircle('blue')">10</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicsixteenlvlfour";
    }
