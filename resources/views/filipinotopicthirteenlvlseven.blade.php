...
@section('title', 'Pang-ukol | Antas 7 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    PAPASOK NA SIYA SA KANYANG BAHAY, NANG MAY BIGLANG NAGSALITA.
    ALIN ANG NAGSASAAD NG PANG-UKOL SA PANGUNGUSAP?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Salita</button>
    <button class="choice" onclick="showCircle('red')">Bahay</button>
    <button class="choice" onclick="showCircle('blue')">Nang may</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicthirteenlvleight";
    }
