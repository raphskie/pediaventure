...
@section('title', 'Pantangi at Pambalana | Antas 10 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ANG KANIYANG <u>PUSA</u> NA SI MINNIE AY MAHILIG MAGLARO.
    ALIN SA MGA SUMUSUNOD AY ANG NAGSASAAD SA NAKULAYANG SALITA?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Pantangi</button>
    <button class="choice" onclick="showCircle('blue')">Pambalana</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicfivelevels";
    }
