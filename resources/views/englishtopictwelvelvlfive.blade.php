...
@section('title', 'Positive, Comparative, and Superlative Degree | Level 5 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE <u>MOST PUNCTUAL</u> AWARD GOES TO HIM.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopictwelvelvlsix";
    }
