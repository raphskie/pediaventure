...
@section('title', 'Conversion of Time | Level 8 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">CONVERT 5 HOURS TO MINUTES.</h1>
  </div>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicfourteenlvlnine";
    }
