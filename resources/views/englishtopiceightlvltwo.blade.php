...
@section('title', 'Identifying the Subject and Predicate | Level 2 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE MYSTERIOUS MAN IS WATCHING A MOVIE.
...
">
    ...
    ">The mysterious man</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">is watching a movie</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopiceightlvlthree";
    }
