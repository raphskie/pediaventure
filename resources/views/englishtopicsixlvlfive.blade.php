...
@section('title', 'Compound Words | Level 5 English | PEDIAVENTURE')
...
">
    ...
    ">He wants to borrow his surfboard</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">There are a lot of cars in the road.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">The park has a lot of people on Saturdays.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicsixlvlsix";
    }
