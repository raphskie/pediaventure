...
@section('title', 'Pandiwa | Antas 4 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ANG KANIYANG LARUAN AY GUMAGALAW.
    ALIN SA PAGPILIAN ANG NAGSASAAD NG KILOS O GALAW?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">GUMAGALAW</button>
    <button class="choice" onclick="showCircle('red')">LARUAN</button>
    <button class="choice" onclick="showCircle('red')">KANIYANG</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicninelvlfive";
    }
