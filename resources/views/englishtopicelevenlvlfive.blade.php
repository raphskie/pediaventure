...
@section('title', 'Adjective  | Level 5 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THAT CHANDELIER LOOKS ELEGANT.
      WHERE IS THE ADJECTIVE IN THE SENTENCE?
    </h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">Elegant</button>
    <button class="choice" onclick="showCircle('red')">Chandelier</button>
    <button class="choice" onclick="showCircle('red')">Looks</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicelevenlvlsix";
    }
