...
@section('title', 'Wastong Paggalang, Pagbati, Pakiki-usap, at Paghingi ng Paumanhin | Antas 6 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    IKAW AY NIREGALUHAN NG IYONG MATALIK NA KAIBIGAN SA IYONG KAARAWAN.
    ALIN ANG WASTONG PANGUNGUSAP PARA DITO?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">MARAMING SALAMAT, KAIBIGAN!</button>
    <button class="choice" onclick="showCircle('red')">SIGE.</button>
    <button class="choice" onclick="showCircle('red')">AYAW KO IYAN!</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicsixlvlseven";
    }
