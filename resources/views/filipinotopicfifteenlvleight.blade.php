...
@section('title', 'Pangatnig | Antas 8 Filipino | PEDIAVENTURE')
...
">
    ...
    ">Siya ay nag-aaral para maging matalino.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Ang estudyante ay gumuguhit ng larawan.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Ang mga guro ay nakikipag-usap.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicfifteenlvlnine";
    }
