...
@section('title', 'Identifying the Standard Measurement | Level 10 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    THE WIDTH OF A CELLPHONE CAN BE MEASURED IN WHAT TYPE?</h1>
  </div>
...
">
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicseventeenlevels";
    }
