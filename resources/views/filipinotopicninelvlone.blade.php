...
@section('title', 'Pandiwa | Antas 1 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    SIYA AY NAGLALAKAD PAPUNTA SA ESKWELAHAN.
    ALIN SA PAGPILIAN ANG NAGSASAAD NG KILOS O GALAW?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">ESKWELAHAN</button>
    <button class="choice" onclick="showCircle('blue')">NAGLALAKAD</button>
    <button class="choice" onclick="showCircle('red')">SIYA</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicninelvltwo";
    }
