...
@section('title', 'Conversion of Time | Level 10 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">HOW MANY HOURS DOES A SINGLE DAY HAVE?</h1>
  </div>
  ...
  <div class="div-choices1">
    ...
    <button class="choice" onclick="showCircle('blue')">25</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicfourteenlevels";
    }
