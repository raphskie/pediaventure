...
@section('title', 'Prepositions | Level 6 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE WORKERS ARE GOING ___ THE BIG TUNNEL. 
      WHAT IS THE APPROPRIATE PREPOSITION IN THE SENTENCE?
    </h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">About</button>
    <button class="choice" onclick="showCircle('red')">On</button>
    V<button class="choice" onclick="showCircle('blue')">Through</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicnineteenlvlseven";
    }
