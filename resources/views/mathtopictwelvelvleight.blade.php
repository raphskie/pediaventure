...
@section('title', 'Identifying the Improper Fraction | Level 8 Math | PEDIAVENTURE')
...
@section('content')
  ...
  <div class="div-choices3 float1">
    <button class="balloon-choice" onclick="showCircle('red')">52/64</button>
    <button class="balloon-choice" onclick="showCircle('red')">63/74</button>
    <button class="balloon-choice" onclick="showCircle('red')">36/74</button>
    <button class="balloon-choice" onclick="showCircle('blue')">35/31</button>
    <button class="balloon-choice" onclick="showCircle('red')">42/63</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopictwelvelvlnine";
    }
  </script>
