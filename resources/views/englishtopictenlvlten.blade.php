...
@section('title', 'Different Types of Sentences  | Level 10 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">WE ARE GOING TO THE BEACH TODAY.
    </h1>
  </div>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopictenlevels";
    }
