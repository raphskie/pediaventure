...
@section('title', 'Identifying the Subject and Predicate | Level 1 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE CAT IS CHASING THE MOUSE.
...
">
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopiceightlvltwo";
    }
