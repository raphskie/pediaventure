...
@section('title', 'Find the Quotient | Level 2 Math | PEDIAVENTURE')
...
@section('content')
  ...
  <div class="div-choices3 float2">
    ...
    <button class="balloon-choice" onclick="showCircle('blue')">2</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopictenlvlthree";
    }
  </script>
