...
@section('title', 'Different Types of Sentences  | Level 6 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE BOSS WANTS TO ANNOUNCE AN EVENT TO ALL EMPLOYEES.
    </h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">Declarative</button>
    ...
    <button class="choice" onclick="showCircle('red')">Exclamatory</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopictenlvlseven";
    }
