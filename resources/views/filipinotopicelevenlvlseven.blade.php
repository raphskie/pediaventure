...
@section('title', 'Pang-uring Panlarawan at Pang-uring Pamilang | Antas 7 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    KAMI AY BINIGYAN NG <u>MAKAPAL</u> NA LIBRO.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicelevenlvleight";
    }
