...
@section('title', 'Standard Forms | Level 4 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">WHAT IS THE STANDARD FORM OF 40 + 10?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">50</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopictwolvlfive";
    }
