...
@section('title', 'Positive, Comparative, and Superlative Degree | Level 4 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE EAGLE IS <u>FASTER</u> THAN THE DOG.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopictwelvelvlfive";
    }
