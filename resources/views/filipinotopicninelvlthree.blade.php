...
@section('title', 'Pandiwa | Antas 3 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ANG ISDA AY MABILIS LUMANGOY.
    ALIN SA PAGPILIAN ANG NAGSASAAD NG KILOS O GALAW?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">ISDA</button>
    <button class="choice" onclick="showCircle('red')">MABILIS</button>
    <button class="choice" onclick="showCircle('blue')">LUMANGOY</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicninelvlfour";
    }
