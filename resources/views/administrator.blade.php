...
<div class="container">
    ...
    <div class="container admindiv1 d-flex" id="register-section">
        ...
        <div class="h1-admin">
            ...
            <a href="{{ route('personal-information.batch') }}" class="adminlink1 w-100 h-25" style="margin-top: 10px; background-color: #17a2b8;">Batch</a>
        </div>
    </div>
    ...
    <div class="container admindiv1 d-flex" id="lessons-section">
        ...
        <div class="h1-admin">
            ...
            <div class="admindiv2">
            <a href="/login" class="adminlink1 w-100 h-25">Games</a>
        </div>
    </div>
