...
@section('title', 'Tambalang Salita | Antas 1 Filipino | PEDIAVENTURE')
...
">
    ...
    ">Ako ay naglakad pauwi sa aking bahay.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Ang mga guro ay nagsalo-salo.</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Siya ay isang balat-sibuyas.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicfourteenlvltwo";
    }
