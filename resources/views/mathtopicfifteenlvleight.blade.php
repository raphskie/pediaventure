...
@section('title', 'Time Measurement of Days, Weeks, Months, and Years | Level 8 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">HOW MANY DAYS DOES 4 WEEKS HAVE?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">32</button>
    <button class="choice" onclick="showCircle('red')">24</button>
    <button class="choice" onclick="showCircle('blue')">28</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicfifteenlvlnine";
    }
