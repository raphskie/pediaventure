...
@section('title', 'Identifying Time | Level 5 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    <img class="fraction-img" src="http://127.0.0.1:8000/imgs/time/5.png">
  </div>

  <div class="div-choices3 float1">
    <button class="balloon-choice" onclick="showCircle('blue')">10:45</button>
    <button class="balloon-choice" onclick="showCircle('red')">3:35</button>
    <button class="balloon-choice" onclick="showCircle('red')">1:10</button>
    <button class="balloon-choice" onclick="showCircle('red')">2:30</button>
    <button class="balloon-choice" onclick="showCircle('red')">6:45</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopicthirteenlvlsix";
    }
  </script>
