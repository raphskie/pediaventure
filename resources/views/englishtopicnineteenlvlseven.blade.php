...
@section('title', 'Prepositions | Level 7 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">HE IS SWIMMING ___ THE SEA.
      WHAT IS THE APPROPRIATE PREPOSITION IN THE SENTENCE?
    </h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">During</button>
    <button class="choice" onclick="showCircle('blue')">Across</button>
    V<button class="choice" onclick="showCircle('red')">Until</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicnineteenlvleight";
    }
