...
@section('back-link', 'englishtopictwelvelevels')
@section('title', 'Positive, Comparative, and Superlative Degree | Level 8 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THAT PAINTING IS <u>MORE BEAUTIFUL</u> THAN THAT PAINTING.
      WHAT DEGREE OF COMPARISON DOES THE COLORED WORD EXPRESS?
    </h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Positive</button>
    <button class="choice" onclick="showCircle('blue')">Comparative</button>
    <button class="choice" onclick="showCircle('red')">Superlative</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopictwelvelvlnine";
    }
