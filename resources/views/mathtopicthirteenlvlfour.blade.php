...
@section('title', 'Identifying Time | Level 4 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    <img class="fraction-img" src="http://127.0.0.1:8000/imgs/time/4.png">
  </div>

  <div class="div-choices3 float1">
    <button class="balloon-choice" onclick="showCircle('red')">10:40</button>
    <button class="balloon-choice" onclick="showCircle('red')">12:20</button>
    <button class="balloon-choice" onclick="showCircle('red')">5:20</button>
    <button class="balloon-choice" onclick="showCircle('blue')">9:00</button>
    <button class="balloon-choice" onclick="showCircle('red')">6:20</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopicthirteenlvlfive";
    }
  </script>
