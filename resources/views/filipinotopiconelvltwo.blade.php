...
@section('title', 'Diptonggo | Antas 2 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Araw</button>
    <button class="choice" onclick="showCircle('red')">Sakay</button>
    <button class="choice" onclick="showCircle('blue')">Apoy</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopiconelvlthree";
    }
