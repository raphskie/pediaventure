...
@section('title', 'Object Measurement | Level 8 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">A MAN IS EXERCISING IN THE GYM AND HE LIFTS 10 POUNDS OF DUMBELL ON EACH HAND.
    HOW MUCH POUNDS IS HE CURRENTLY LIFTING?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">20</button>
    <button class="choice" onclick="showCircle('red')">40</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicsixteenlvlnine";
    }
