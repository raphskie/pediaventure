...
@section('title', 'Capitalization of Words | Level 9 English | PEDIAVENTURE')
...
">
    ...
    ">There's a Pack of frutos in the pantry.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicseventeenlvlten";
    }
