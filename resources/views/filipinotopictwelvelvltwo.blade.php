...
@section('title', 'Kaantasan ng Pang-uri | Antas 2 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    SILA AY <u>MAS MAGALING</u> PA KAYSA SA KABILANG GRUPO.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopictwelvelvlthree";
    }
