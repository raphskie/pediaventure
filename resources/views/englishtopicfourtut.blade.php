...
@section('title', 'Singular and Plural | PEDIAVENTURE')
...
<div class="container-login" 
    ...
    <div class="topic-flex">    
        <p class="p-tutorial">You will be determining whether the colored word is states as a single object or many in
