...
@section('title', 'Pang-uring Panlarawan at Pang-uring Pamilang | Antas 1 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ANG LALAKING IYON AY <u>MAPAYAT</u>.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicelevenlvltwo";
    }
