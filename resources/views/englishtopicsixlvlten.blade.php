...
@section('title', 'Compound Words | Level 10 English | PEDIAVENTURE')
...
">
    ...
    ">They are going to the park together.</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid -37px #57370a;
    ">Jose has a colorful toothbrush</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">It's so windy every June.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicsixlevels";
    }
