...
@section('title', 'Find the Product | Level 6 Math | PEDIAVENTURE')
...
@section('content')
  ...
  <div class="div-choices3 float1">
    <button class="balloon-choice" onclick="showCircle('red')">29</button>
    <button class="balloon-choice" onclick="showCircle('red')">25</button>
    <button class="balloon-choice" onclick="showCircle('blue')">27</button>
    <button class="balloon-choice" onclick="showCircle('red')">20</button>
    <button class="balloon-choice" onclick="showCircle('red')">21</button>
  ...
  <div class="div-choices3 float2">
    ...
    <button class="balloon-choice" onclick="showCircle('red')">22</button>
    <button class="balloon-choice" onclick="showCircle('red')">24</button>
    <button class="balloon-choice" onclick="showCircle('red')">28</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopiceightlvlseven";
    }
  </script>
