...
@section('title', 'Conversion of Time | Level 9 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">CONVERT 10 HOURS TO MINUTES.</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">900</button>
    <button class="choice" onclick="showCircle('red')">800</button>
    <button class="choice" onclick="showCircle('blue')">600</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicfourteenlvlten";
    }
