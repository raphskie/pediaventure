...
@section('title', 'Pang-ukol | Antas 2 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    AYON SA KANIYANG KASABIHAN, SIYA AY ISANG MAHUSAY NA ESTUDYANTE.
    ALIN ANG NAGSASAAD NG PANG-UKOL SA PANGUNGUSAP?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Estudyante</button>
    <button class="choice" onclick="showCircle('blue')">Ayon sa</button>
    <button class="choice" onclick="showCircle('red')">Mahusay</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicthirteenlvlthree";
    }
