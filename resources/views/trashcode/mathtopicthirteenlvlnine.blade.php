...
@section('title', 'Identifying Time | Level 9 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    <img class="fraction-img" src="http://127.0.0.1:8000/imgs/time/9.png">
  </div>

  <div class="div-choices3 float1">
    <button class="balloon-choice" onclick="showCircle('red')">5:35</button>
    <button class="balloon-choice" onclick="showCircle('red')">5:30</button>
    <button class="balloon-choice" onclick="showCircle('red')">5:00</button>
    <button class="balloon-choice" onclick="showCircle('blue')">5:40</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopicthirteenlvlten";
    }
  </script>
