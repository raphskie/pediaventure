...
@section('title', 'Addition and Subtraction | Level 1 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">1 + 10 = ?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">11</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicsevenlvltwo";
    }
