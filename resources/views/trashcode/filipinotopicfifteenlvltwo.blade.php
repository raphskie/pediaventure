...
@section('title', 'Pangatnig | Antas 2 Filipino | PEDIAVENTURE')
...
">
    ...
    ">Siya ay nag-aaral.</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Siya ay naglalakad ngunit siya ay mabagal.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Sila ay pumupunta sa karinderya.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicfifteenlvlthree";
    }
