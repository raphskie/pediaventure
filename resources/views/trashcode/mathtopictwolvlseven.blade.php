...
@section('title', 'Standard Forms | Level 7 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">WHAT IS THE STANDARD FORM OF 90 + 90 + 90?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">250</button>
    <button class="choice" onclick="showCircle('red')">100</button>
    <button class="choice" onclick="showCircle('blue')">270</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopictwolvleight";
    }
