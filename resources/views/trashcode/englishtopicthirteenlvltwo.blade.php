...
@section('title', 'Order of Adjectives | Level 2 English | PEDIAVENTURE')
...
">
    ...
    ">The dog is eating a banana delicious.</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">That cake is bigger and better.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">He is a man tall handsome.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicthirteenlvlthree";
    }
