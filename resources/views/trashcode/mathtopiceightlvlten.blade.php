...
@section('title', 'Find the Product | Level 10 Math | PEDIAVENTURE')
...
@section('content')
  ...
  <div class="div-choices3 float1">
    ...
    <button class="balloon-choice" onclick="showCircle('red')">60</button>
  ...
  <div class="div-choices3 float2">
    ...
    <button class="balloon-choice" onclick="showCircle('red')">5</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopiceightlevels";
    }
  </script>
