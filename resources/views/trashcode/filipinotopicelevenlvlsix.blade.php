...
@section('title', 'Pang-uring Panlarawan at Pang-uring Pamilang | Antas 6 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ANG KWADERNO NG AKING KAIBIGAN AY <u>MANIPIS</u>.
    ALIN SA PAGPILIAN ANG NAGSASAAD NG NAKULAYANG SALITA?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">Panlarawan</button>
    <button class="choice" onclick="showCircle('red')">Pamilang</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicelevenlvlseven";
    }
