...
@section('title', 'Wastong Paggalang, Pagbati, Pakiki-usap, at Paghingi ng Paumanhin | Antas 8 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    IKA-UNANG ARAW MO SA IYONG PAARALAN AT MAY NAIS KANG MALAMAN ANG PANGALAN NG IYONG KAKLASE.
    ALIN ANG WASTONG PANGUNGUSAP PARA DITO?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">TATAHIMIK NALANG AKO.</button>
    <button class="choice" onclick="showCircle('red')">SINO KA?</button>
    <button class="choice" onclick="showCircle('blue')">ANO ANG IYONG PANGALAN?</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicsixlvlnine";
    }
