...
@section('title', 'Object Measurement | Level 6 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">JOSE'S DAD WANTS HIS VIDEO TO BE IN SQUARE RESOLUTION. WHICH OF THE
    FOLLOWING IS THE SQUARE RESOLUTION FOR HIS VIDEO?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">360 X 480</button>
    <button class="choice" onclick="showCircle('red')">480 X 1080</button>
    <button class="choice" onclick="showCircle('blue')">1920 X 1920</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicsixteenlvlseven";
    }
