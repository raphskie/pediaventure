...
@section('title', 'Rhymes | Level 7 English | PEDIAVENTURE')
@section('content')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">WHAT RHYMES WITH "POD"?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">Tod</button>
    <button class="choice" onclick="showCircle('red')">Poem</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicsevenlvleight";
    }
