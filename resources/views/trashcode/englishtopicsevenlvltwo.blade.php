...
@section('title', 'Rhymes | Level 2 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">WHAT RHYMES WITH "KITTY"?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Pat</button>
    <button class="choice" onclick="showCircle('blue')">Witty</button>
    <button class="choice" onclick="showCircle('red')">Nit</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicsevenlvlthree";
    }
