    ...
    <body class="@yield('body-class')">
        ...
        <nav>
            <a class="nav-item" href="javascript:history.back()">
                    <img class="nav-img" src="http://127.0.0.1:8000/imgs/back-button.png" style="transform: scaleX(-1);width: 15%;">
                </a>
            ...
            <a class="nav-item" href="settings" style="display: flex; flex-wrap: wrap; flex-direction: row-reverse; align-content: center; align-items: center;">
                <img class="nav-img" src="http://127.0.0.1:8000/imgs/settings-button.png" style="width: 16%;">
            </a>
        </nav>
        @endunless
