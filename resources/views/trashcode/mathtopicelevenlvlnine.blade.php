...
@section('title', 'Fractions | Level 9 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    <img class="fraction-img" src="http://127.0.0.1:8000/imgs/fractions/9.png">
  </div>

  <div class="div-choices3 float1">
    <button class="balloon-choice" onclick="showCircle('blue')">4/12</button>
    <button class="balloon-choice" onclick="showCircle('red')">4/8</button>
    <button class="balloon-choice" onclick="showCircle('red')">3/4</button>
    <button class="balloon-choice" onclick="showCircle('red')">2/7</button>
    <button class="balloon-choice" onclick="showCircle('red')">4/15</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopicelevenlvlten";
    }
  </script>
