...
@section('title', 'Compound Words | Level 9 English | PEDIAVENTURE')
...
">
    ...
    ">The police are watching the streets.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid -37px #57370a;
    ">He is going to play a famous piece.</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">We watch Showtime every afternoon</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicsixlvlten";
    }
