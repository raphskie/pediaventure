...
@section('title', 'Kaantasan ng Pang-uri | Antas 1 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    SIYA AY ANG <u>PINAKAMATALINO</u> SA KLASE.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopictwelvelvltwo";
    }
