...
@section('title', 'Kaantasan ng Pang-uri | Antas 4 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ANG KANIYANG BUHOK AY <u>MAS MAHABA KAYSA</u> KAY AMELIA.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopictwelvelvlfive";
    }
