...
@section('title', 'Singular and Plural | Level 9 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE <u>GLASS OF WATER</u> IS ON THE TABLE.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicfourlvlten";
    }
