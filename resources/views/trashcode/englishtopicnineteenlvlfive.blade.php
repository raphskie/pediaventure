...
@section('title', 'Prepositions | Level 5 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE FAMILY IS GOING ___ FOR A STROLL. 
      WHAT IS THE APPROPRIATE PREPOSITION IN THE SENTENCE?
    </h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">Out</button>
    <button class="choice" onclick="showCircle('red')">From</button>
    V<button class="choice" onclick="showCircle('red')">About</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicnineteenlvlsix";
    }
