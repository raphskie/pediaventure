...
@section('title', 'Identifying Time | Level 3 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    <img class="fraction-img" src="http://127.0.0.1:8000/imgs/time/3.png">
  </div>

  <div class="div-choices3 float1">
    <button class="balloon-choice" onclick="showCircle('red')">6:50</button>
    <button class="balloon-choice" onclick="showCircle('blue')">3:30</button>
    <button class="balloon-choice" onclick="showCircle('red')">2:20</button>
    <button class="balloon-choice" onclick="showCircle('red')">2:00</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopicthirteenlvlfour";
    }
  </script>
