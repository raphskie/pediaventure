...
@section('title', 'Panghalip Panao | Antas 1 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <u>SIYA</u> AY GUMAGAWA NG KANYANG TAKDANG-ARALIN. 
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicsevenlvltwo";
    }
