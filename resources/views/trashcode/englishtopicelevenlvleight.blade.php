...
@section('title', 'Adjective  | Level 8 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">SAMSUNG IS A FAMOUS PHONE BRAND.
      WHERE IS THE ADJECTIVE IN THE SENTENCE?
    </h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Phone</button>
    <button class="choice" onclick="showCircle('red')">Brand</button>
    <button class="choice" onclick="showCircle('blue')">Famous</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicelevenlvlnine";
    }
