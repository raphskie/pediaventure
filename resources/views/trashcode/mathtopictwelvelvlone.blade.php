...
@section('title', 'Identifying the Improper Fraction | Level 1 Math | PEDIAVENTURE')
...
@section('content')
  ...
  <div class="div-choices3 float1">
    <button class="balloon-choice" onclick="showCircle('blue')">10/1</button>
    <button class="balloon-choice" onclick="showCircle('red')">2/3</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopictwelvelvltwo";
    }
  </script>
