...
@section('title', 'Diptonggo | Antas 4 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Apay</button>
    <button class="choice" onclick="showCircle('red')">Bawang</button>
    <button class="choice" onclick="showCircle('blue')">Araw</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopiconelvlfive";
    }
