...
@section('title', 'Kaantasan ng Pang-uri | Antas 5 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ANG TAKBO NI USAIN BOLT AY ANG <u>PINAKAMABILIS</u> SA BUONG MUNDO.
  ...
  <div class="div-choices1">
    ...
    <button class="choice" onclick="showCircle('blue')">Pasukdol</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopictwelvelvlsix";
    }
