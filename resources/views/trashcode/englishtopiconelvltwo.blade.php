...
@section('title', 'Nouns | Level 2 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">WHERE IS JOSE'S DOG?
      WHICH OF THE FOLLOWING IS THE NOUN IN THE SENTENCE?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">WHERE</button>
    <button class="choice" onclick="showCircle('blue')">JOSE'S</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopiconelvlthree";
    }
