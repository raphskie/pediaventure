...
@section('title', 'Object Measurement | Level 4 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">A LENGTH OF AN AVERAGE 17-CENTIMETER PENCIL CAN BE ADDED UP TO 2 CENTIMETERS.
    WHAT WOULD BE THE OTHER LENGTH OF THE PENCIL?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">17</button>
    <button class="choice" onclick="showCircle('red')">18</button>
    <button class="choice" onclick="showCircle('blue')">19</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicsixteenlvlfive";
    }
