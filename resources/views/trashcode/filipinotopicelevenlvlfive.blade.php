...
@section('title', 'Pang-uring Panlarawan at Pang-uring Pamilang | Antas 5 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ANG KANIYANG BUHOK AY <u>MAHABA</u>.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicelevenlvlsix";
    }
