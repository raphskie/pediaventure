...
@section('title', 'Identifying the Subject and Predicate | Level 6 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction"> WE LOVE READING AND WRITING.
...
">
    ...
    background: #c38543;
    border: solid 7px #57370a;
    ">love reading and writing</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopiceightlvlseven";
    }
