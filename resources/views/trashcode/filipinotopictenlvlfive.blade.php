...
@section('title', 'Pang-uri | Antas 5 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ANG HARDIN SA PAARALAN AY MAGANDA.
  ...
  <div class="div-choices1">
    ...
    <button class="choice" onclick="showCircle('red')">HARDIN</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopictenlvlsix";
    }
