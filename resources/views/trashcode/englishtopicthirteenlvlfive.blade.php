...
@section('title', 'Order of Adjectives | Level 5 English | PEDIAVENTURE')
...
">
    ...
    ">The white cat small is resting on the bed.</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">The small white cat is resting on the bed.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">The cat small white is resting on the bed.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicthirteenlvlsix";
    }
