...
@section('back-link', 'englishtopicelevenlevels')
@section('title', 'Adjective  | Level 9 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">CHEETAHS ARE VERY FAST ANIMALS.
      WHERE IS THE ADJECTIVE IN THE SENTENCE?
    </h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Animals</button>
    <button class="choice" onclick="showCircle('blue')">Very fast</button>
    <button class="choice" onclick="showCircle('red')">Cheetahs</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicelevenlvlten";
    }
