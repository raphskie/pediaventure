...
@section('title', 'Wastong Paggalang, Pagbati, Pakiki-usap, at Paghingi ng Paumanhin | Antas 1 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    IKAW AY NAKIKIPAG-USAP SA IYONG TIYAHIN AT HINAHANAP NIYA ANG IYONG KAPATID, NGUNIT WALA SIYA SA IYONG BAHAY.
    ALIN ANG WASTONG PANGUNGUSAP PARA DITO?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">WALA.</button>
    <button class="choice" onclick="showCircle('blue')">WALA PO SIYA DITO, TITA.</button>
    <button class="choice" onclick="showCircle('red')">EWAN KO.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicsixlvltwo";
    }
