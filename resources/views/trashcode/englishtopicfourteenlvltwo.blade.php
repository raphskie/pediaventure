...
@section('title', 'Subject Verb Agreement and Verb Phrase | Level 2 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE PIZZA IS STEAMING.
    WHERE IS THE VERB IN THE SENTENCE?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">The</button>
    <button class="choice" onclick="showCircle('blue')">Steaming</button>
    <button class="choice" onclick="showCircle('red')">Pizza</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicfourteenlvlthree";
    }
