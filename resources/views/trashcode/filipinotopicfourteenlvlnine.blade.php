...
@section('title', 'Tambalang Salita | Antas 9 Filipino | PEDIAVENTURE')
...
">
    ...
    ">Ang taong iyon ay may pag-iisip ng parang bata.</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Ang taong iyon ay isip-bata.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Ang taong iyon ay parang bata mag-isip.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicfourteenlvlten";
    }
