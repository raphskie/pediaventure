...
@section('title', 'Tambalang Salita | Antas 10 Filipino | PEDIAVENTURE')
...
">
    ...
    ">Kami ay nagpunta sa isang silid ng paaralan.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Siya ay namimili kung ano ang kaniyang kakainin.</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Siya ay naging urong-sulong nang matapos silang mag-usap.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicfourteenlevels";
    }
