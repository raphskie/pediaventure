...
@section('title', 'Subject Verb Agreement and Verb Phrase | Level 6 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE FISHERMAN CAUGHT A VERY BIG FISH.
    WHERE IS THE VERB IN THE SENTENCE?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Very big fish</button>
    <button class="choice" onclick="showCircle('blue')">Caught</button>
    <button class="choice" onclick="showCircle('red')">The fisherman</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicfourteenlvlseven";
    }
