...
@section('title', 'Wastong Paggalang, Pagbati, Pakiki-usap, at Paghingi ng Paumanhin | Antas 5 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    IKAW AY NAGPUNTA SA MATALIK MONG KAIBIGAN NA MAY KAARAWAN AT SIYA AY LUMAPIT SA IYO!
    ALIN ANG WASTONG PANGUNGUSAP PARA DITO?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">LAYO KA!</button>
    <button class="choice" onclick="showCircle('red')">SIGE.</button>
    <button class="choice" onclick="showCircle('blue')">MALIGAYANG KAARAWAN SA IYO, KAIBIGAN!</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicsixlvlsix";
    }
