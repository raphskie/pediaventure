...
@section('title', 'Positive, Comparative, and Superlative Degree | Level 10 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">HE IS THE <u>SMARTEST</u> MAN IN THE WORLD
  ...
  <div class="div-choices1">
    ...
    <button class="choice" onclick="showCircle('red')">Comparative</button>
    <button class="choice" onclick="showCircle('blue')">Superlative</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopictwelvelevels";
    }
