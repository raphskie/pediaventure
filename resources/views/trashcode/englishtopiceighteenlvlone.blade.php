...
@section('title', 'Dipthongs | Level 1 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">WHAT WORD HAS A DIPTHONG "OY"?
    </h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">Boy</button>
    <button class="choice" onclick="showCircle('red')">Bop</button>
    V<button class="choice" onclick="showCircle('red')">Now</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopiceighteenlvltwo";
    }
