...
@section('title', 'Find the Product | Level 3 Math | PEDIAVENTURE')
...
@section('content')
  ...
  <div class="div-choices3 float1">
    ...
    <button class="balloon-choice" onclick="showCircle('red')">49</button>
  ...
  <div class="div-choices3 float2">
    ...
    function nextLevel() {
      window.location.href = "mathtopiceightlvlfour";
    }
  </script>
