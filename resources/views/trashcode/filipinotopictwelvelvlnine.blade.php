...
@section('title', 'Kaantasan ng Pang-uri | Antas 9 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ANG KANIYANG LARUAN AY <u>MAS MABILIS</u> KAYSA SA KANYA.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopictwelvelvlten";
    }
