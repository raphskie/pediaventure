...
@section('title', 'Panghalip Panao | Antas 2 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    NASA <u>KANILA</u> ANG LIBRONG HINAHANAP NATIN.
    ANG NAKULAYANG SALITA AY NAGSASAAD NG...</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">ISAHAN</button>
    <button class="choice" onclick="showCircle('red')">DALAWAHAN</button>
    <button class="choice" onclick="showCircle('blue')">MARAMIHAN</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicsevenlvlthree";
    }
