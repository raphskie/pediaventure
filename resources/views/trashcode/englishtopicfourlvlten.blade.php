...
@section('title', 'Singular and Plural | Level 10 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THAT SHOP SELLS <u>FURNITURES</u>.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicfourlevels";
    }
