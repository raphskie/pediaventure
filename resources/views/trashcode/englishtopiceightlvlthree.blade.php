...
@section('title', 'Identifying the Subject and Predicate | Level 3 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE FLOWERS HAVE BLOOMED IN THE GARDEN.
...
">
    ...
    background: #c38543;
    border: solid 7px #57370a;
    ">have bloomed in the garden.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopiceightlvlfour";
    }
