...
@section('title', 'Synonyms and Antonyms | Level 4 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">What is the antonym of "Boy"?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">Girl</button>
    <button class="choice" onclick="showCircle('red')">Man</button>
    <button class="choice" onclick="showCircle('red')">Guy</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicfivelvlfive";
    }
