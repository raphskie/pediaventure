...
@section('title', 'Wastong Paggamit ng Dayalogo | Antas 10 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    font-size: 22px;
    font-weight: lighter;
      ">IKAW AY NAKASAKAY SA ISANG DYIP AT ANG IYONG PATUTUNGUHAN AY PALAPIT NA.
  ...
  <div class="div-choices1" style="
    ...
    flex-wrap: wrap;
">
    <button class="choice2" onclick="showCircle('red')">TUMIGIL!</button>
    <button class="choice2" onclick="showCircle('red')">IBABA MO NA AKO!</button>
    <button class="choice2" onclick="showCircle('blue')">PARA PO!</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicfourlevels";
    }
