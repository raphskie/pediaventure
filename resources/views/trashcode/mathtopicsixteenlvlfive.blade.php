...
@section('title', 'Object Measurement | Level 5 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">JOSE WANTS TO BUY A PERFECT SQUARE CANVAS AT THE ART SUPPLIES STORE.
    WHICH OF THE FOLLOWING IS THE MEASUREMENT FOR A PERFECT SQUARE?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">16 CM X 16 CM</button>
    <button class="choice" onclick="showCircle('red')">15 CM X 14 CM</button>
    <button class="choice" onclick="showCircle('red')">12 CM X 15 CM</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicsixteenlvlsix";
    }
