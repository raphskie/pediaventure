...
@section('title', 'Adjective  | Level 4 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">SHE AND HER MOTHER ARE BEAUTIFUL.
      WHERE IS THE ADJECTIVE IN THE SENTENCE?
    </h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Mother</button>
    <button class="choice" onclick="showCircle('blue')">Beautiful</button>
    <button class="choice" onclick="showCircle('red')">She</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicelevenlvlfive";
    }
