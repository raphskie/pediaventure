...
@section('title', 'Panghalip Pananong | Antas 4 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="div-choices1">
    ...
    <button class="choice" onclick="showCircle('blue')">PAANO</button>
    <button class="choice" onclick="showCircle('red')">GANIYAN</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopiceightlvlfive";
    }
