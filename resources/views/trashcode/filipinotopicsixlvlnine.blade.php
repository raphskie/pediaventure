...
@section('title', 'Wastong Paggalang, Pagbati, Pakiki-usap, at Paghingi ng Paumanhin | Antas 9 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    KAARAWAN NG IYONG GURO AT NAIS MO SIYANG BATIIN.
    ALIN ANG WASTONG PANGUNGUSAP PARA DITO?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">MALIGAYANG KAARAWAN PO, GINANG/BINIBINI!</button>
    <button class="choice" onclick="showCircle('red')">KAMUSTA NA PO KAYO?</button>
    <button class="choice" onclick="showCircle('red')">ANO PO ANG IYONG PANGALAN?</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicsixlvlten";
    }
