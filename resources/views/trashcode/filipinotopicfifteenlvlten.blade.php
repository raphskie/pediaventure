...
@section('title', 'Pangatnig | Antas 10 Filipino | PEDIAVENTURE')
...
">
    ...
    ">Siya ay bumibili ng kanyang pagkain sa labas ng paaralan.</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Siya ay hindi pumasok sa paaralan dahil siya ay may sakit.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Siya ay sinuklian sa tindahan.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicfifteenlevels";
    }
