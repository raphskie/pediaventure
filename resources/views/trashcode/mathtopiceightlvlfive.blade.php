...
@section('title', 'Find the Product | Level 5 Math | PEDIAVENTURE')
...
@section('content')
  ...
  <div class="div-choices3 float1">
    <button class="balloon-choice" onclick="showCircle('red')">47</button>
    <button class="balloon-choice" onclick="showCircle('red')">36</button>
    <button class="balloon-choice" onclick="showCircle('red')">27</button>
    <button class="balloon-choice" onclick="showCircle('red')">17</button>
    <button class="balloon-choice" onclick="showCircle('red')">39</button>
  ...
  <div class="div-choices3 float2">
    ...
    <button class="balloon-choice" onclick="showCircle('red')">23</button>
    <button class="balloon-choice" onclick="showCircle('red')">18</button>
    <button class="balloon-choice" onclick="showCircle('blue')">30</button>
    <button class="balloon-choice" onclick="showCircle('red')">15</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopiceightlvlsix";
    }
  </script>
