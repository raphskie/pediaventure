...
@section('back-link', 'filipinotopicthirteenlevels')
@section('title', 'Pang-ukol | Antas 9 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    SIYA ANG NAGHAHANDA NG REGALO PARA SA KAARAWAN NG KANIYANG KAIBIGAN.
    ALIN ANG NAGSASAAD NG PANG-UKOL SA PANGUNGUSAP?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Kaibigan</button>
    <button class="choice" onclick="showCircle('blue')">Para sa</button>
    <button class="choice" onclick="showCircle('red')">Kaarawan</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicthirteenlvlten";
    }
