...
@section('back-link', 'mathtopicsevenlevels')
@section('title', 'Addition and Subtraction | Level 10 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">34 - 4 - 2 - 1 + 12 + 13 + 10 = ?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">60</button>
    <button class="choice" onclick="showCircle('red')">61</button>
    <button class="choice" onclick="showCircle('blue')">62</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicsevenlevels";
    }
