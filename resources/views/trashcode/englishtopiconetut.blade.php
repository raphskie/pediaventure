...
@section('title', 'Nouns | PEDIAVENTURE')
...
<div class="container-login" 
    ...
    <div class="topic-flex">    
        <p class="p-tutorial">You will be determining or identifying the name of a person, object, or an event, in
        the question above. Choose the correct answer below. You can do it, adventurer!</p>

        <a href="englishtopiconelevels" class="home-log-reg" style="
            width: 46%;
            margin-left: auto;
            margin-right: auto;
        ">PROCEED</a>    
