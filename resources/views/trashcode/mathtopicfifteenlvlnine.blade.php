...
@section('title', 'Time Measurement of Days, Weeks, Months, and Years | Level 9 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">HOW MANY DAYS DOES A YEAR HAVE?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">365</button>
    <button class="choice" onclick="showCircle('red')">360</button>
    <button class="choice" onclick="showCircle('red')">364</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicfifteenlvlten";
    }
