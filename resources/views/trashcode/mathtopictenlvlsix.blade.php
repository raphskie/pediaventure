...
@section('title', 'Find the Quotient | Level 6 Math | PEDIAVENTURE')
...
@section('content')
  ...
  <div class="div-choices3 float2">
    ...
    <button class="balloon-choice" onclick="showCircle('red')">1</button>
    <button class="balloon-choice" onclick="showCircle('blue')">5</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopictenlvlseven";
    }
  </script>
