...
@section('title', 'Synonyms and Antonyms | Level 5 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">What is the synonym of "Big"?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Small</button>
    <button class="choice" onclick="showCircle('blue')">Huge</button>
    <button class="choice" onclick="showCircle('red')">Tiny</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicfivelvlsix";
    }
