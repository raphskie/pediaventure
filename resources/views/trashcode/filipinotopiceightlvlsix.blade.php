...
@section('title', 'Panghalip Pananong | Antas 6 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    SAAN MATATAGPUAN ANG BAYAN NG ALAMINOS?
    ALIN SA PAGPILIAN ANG NAGSASAAD NG KATANUNGAN?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">BAYAN</button>
    <button class="choice" onclick="showCircle('red')">ALAMINOS</button>
    <button class="choice" onclick="showCircle('blue')">SAAN</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopiceightlvlseven";
    }
