...
@section('title', 'Addition and Subtraction | Level 6 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">21 - 4 = ?</h1>
  </div>
  ...
  <div class="div-choices1">
    ...
    <button class="choice" onclick="showCircle('blue')">17</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicsevenlvlseven";
    }
