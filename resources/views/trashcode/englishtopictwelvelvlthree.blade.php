...
@section('title', 'Positive, Comparative, and Superlative Degree | Level 3 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">HE IS A <u>BETTER WRITER</u> THAN HIM.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopictwelvelvlfour";
    }
