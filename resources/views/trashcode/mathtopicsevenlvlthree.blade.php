...
@section('title', 'Addition and Subtraction | Level 3 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">23 + 7 = ?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">34</button>
    <button class="choice" onclick="showCircle('red')">23</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicsevenlvlfour";
    }
