...
@section('title', 'Capitalization of Words | Level 3 English | PEDIAVENTURE')
...
">
    ...
    ">That bag of Piattos looks delicious.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">We are going to sm On saturday.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">The brand of his Bag is jansport.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicseventeenlvlfour";
    }
