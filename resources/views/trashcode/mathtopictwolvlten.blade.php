...
@section('back-link', 'mathtopictwolevels')
@section('title', 'Standard Forms | Level 10 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">WHAT IS THE STANDARD FORM OF 3100 + 1000 + 500?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">4600</button>
    <button class="choice" onclick="showCircle('red')">4300</button>
    <button class="choice" onclick="showCircle('red')">4200</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopictwolevels";
    }
