...
@section('title', 'Fractions | Level 3 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    <img class="fraction-img" src="http://127.0.0.1:8000/imgs/fractions/3.png">
  </div>

  <div class="div-choices3 float1">
    <button class="balloon-choice" onclick="showCircle('red')">1/2</button>
    <button class="balloon-choice" onclick="showCircle('red')">2/9</button>
    ...
    <button class="balloon-choice" onclick="showCircle('blue')">1/4</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopicelevenlvlfour";
    }
  </script>
