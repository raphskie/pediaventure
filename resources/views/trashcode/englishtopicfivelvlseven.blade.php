...
@section('title', 'Synonyms and Antonyms | Level 7 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">What is the antonym of "fast"?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">Slow</button>
    <button class="choice" onclick="showCircle('red')">Swift</button>
    <button class="choice" onclick="showCircle('red')">Quick</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicfivelvleight";
    }
