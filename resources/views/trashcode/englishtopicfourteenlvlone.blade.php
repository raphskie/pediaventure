...
@section('title', 'Subject Verb Agreement and Verb Phrase | Level 1 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE DOG IS PLAYING WITH THE BALL.
    WHERE IS THE SUBJECT IN THE SENTENCE?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">Dog</button>
    <button class="choice" onclick="showCircle('red')">Playing</button>
    <button class="choice" onclick="showCircle('red')">The</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicfourteenlvltwo";
    }
