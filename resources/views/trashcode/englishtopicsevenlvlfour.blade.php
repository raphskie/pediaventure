...
@section('title', 'Rhymes | Level 4 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">WHAT RHYMES WITH "YET"?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Has</button>
    <button class="choice" onclick="showCircle('blue')">Bet</button>
    <button class="choice" onclick="showCircle('red')">Yarn</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicsevenlvlfive";
    }
