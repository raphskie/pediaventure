...
@section('back-link', 'filipinotopiconelevels')
@section('title', 'Diptonggo | Antas 3 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">ALIN SA MGA SUMUSUNOD ANG MAY DIPTONGGO NA <u>"AY"</u></h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Maaraw</button>
    <button class="choice" onclick="showCircle('blue')">Sakay</button>
    <button class="choice" onclick="showCircle('red')">Umapaw</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopiconelvlfour";
    }
