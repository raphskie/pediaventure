...
@section('title', 'Wastong Paggalang, Pagbati, Pakiki-usap, at Paghingi ng Paumanhin | Antas 2 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    IKAW AY MAY GINAGAWA SA IYONG TAHANAN, NGUNIT NANGANGAILANGAN KA NG TULONG SA IYONG NAKAKATANDANG KAPATID. 
    ALIN ANG WASTONG PANGUNGUSAP PARA DITO?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">TULUNGAN NIYO NGA AKO.</button>
    <button class="choice" onclick="showCircle('red')">HOY, TULONG!</button>
    <button class="choice" onclick="showCircle('blue')">KUYA/ATE, PWEDE NIYO PO BA AKO TULUNGAN?</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicsixlvlthree";
    }
