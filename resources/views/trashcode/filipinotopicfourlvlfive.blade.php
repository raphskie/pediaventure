...
@section('title', 'Wastong Paggamit ng Dayalogo | Antas 5 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    font-size: 22px;
    font-weight: lighter;
">NAKITA MO ANG IYONG KALARO NA NADAPA SA PUTIKAN AT NANGANGAILANGAN NG TULONG. 
  ...
  <div class="div-choices1" style="
    ...
    flex-wrap: wrap;
">
    <button class="choice2" onclick="showCircle('blue')">HALINA'T TULUNGAN KITA DYAN.</button>
    <button class="choice2" onclick="showCircle('red')">BAHALA KA SA BUHAY MO!</button>
    <button class="choice2" onclick="showCircle('red')">ANG ASO AY TUMATAHOL.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicfourlvlsix";
    }
