...
@section('title', 'Syllabicating Words | Level 9 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">HOW MANY SYLLABLES DOES <u>"BUSINESSWOMAN"</u> HAVE?</h1>
  </div>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicsixteenlvlten";
    }
