...
@section('title', 'Identifying the Subject and Predicate | Level 7 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">WE ARE GOING TO THE PARK LATER.
...
">
    ...
    background: #c38543;
    border: solid 7px #57370a;
    ">are going to the park later</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopiceightlvleight";
    }
