...
@section('title', 'Conversion of Time | Level 1 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">CONVERT 1 MINUTE TO SECONDS.</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">30</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicfourteenlvltwo";
    }
