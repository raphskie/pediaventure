...
@section('title', 'Synonyms and Antonyms | Level 8 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">What is the antonym of "loud"?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Witty</button>
    <button class="choice" onclick="showCircle('blue')">Quiet</button>
    <button class="choice" onclick="showCircle('red')">Picky</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicfivelvlnine";
    }
