...
@section('title', 'Capitalization of Words | Level 6 English | PEDIAVENTURE')
...
">
    ...
    ">There's a lot of people at lucap wharf Tonight.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">There's a Lot of people at lucap wharf tonight.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicseventeenlvlseven";
    }
