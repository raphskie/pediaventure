...
@section('title', 'Subject Verb Agreement and Verb Phrase | Level 5 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE BUSINESSMEN ARE GOING TO WORK EARLY.
    WHERE IS THE SUBJECT IN THE SENTENCE?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Going</button>
    <button class="choice" onclick="showCircle('red')">Work</button>
    <button class="choice" onclick="showCircle('blue')">The businessmen</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicfourteenlvlsix";
    }
