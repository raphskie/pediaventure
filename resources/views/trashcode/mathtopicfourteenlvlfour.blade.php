...
@section('title', 'Conversion of Time | Level 4 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">CONVERT 30 SECONDS TO MINUTES.</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">1</button>
    <button class="choice" onclick="showCircle('blue')">HALF A MINUTE</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicfourteenlvlfive";
    }
