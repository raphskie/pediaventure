...
@section('title', 'Object Measurement | Level 7 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">A SINGLE APPLE WEIGHTS ABOUT 6 OUNCES. IF 4 MORE APPLES ARE ADDED UP,
    WHAT WOULD BE THE TOTAL WEIGHT?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">22</button>
    <button class="choice" onclick="showCircle('blue')">24</button>
    <button class="choice" onclick="showCircle('red')">20</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicsixteenlvleight";
    }
