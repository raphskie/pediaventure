...
@section('title', 'Panghalip Pananong | Antas 1 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    BAKIT IKAW AY MASAYA?
    ALIN SA PAGPILIAN ANG NAGSASAAD NG KATANUNGAN?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">MASAYA</button>
    <button class="choice" onclick="showCircle('blue')">BAKIT</button>
    <button class="choice" onclick="showCircle('red')">IKAW</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopiceightlvltwo";
    }
