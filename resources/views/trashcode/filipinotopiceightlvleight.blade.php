...
@section('back-link', 'filipinotopiceightlevels')
@section('title', 'Panghalip Pananong | Antas 8 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ILAN ANG MGA ESTUDYANTE SA IKA-TATLONG BAITANG?
    ALIN SA PAGPILIAN ANG NAGSASAAD NG KATANUNGAN?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">BAITANG</button>
    <button class="choice" onclick="showCircle('red')">ESTUDYANTE</button>
    <button class="choice" onclick="showCircle('blue')">ILAN</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopiceightlvlnine";
    }
