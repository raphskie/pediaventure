...
@section('title', 'Patinig at Katinig | Antas 7 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    <h1 class="h1-instruction">ANG KANIYANG <u>LAPIS</u> AY MAGANDA. ANG NAKULAYANG SALITA AY ALIN
      SA MGA SUMUSUNOD?</h1>
  </div>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopictwolvleight";
    }
