...
@section('title', 'Diptonggo | Antas 9 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="div-choices1">
    ...
    <button class="choice" onclick="showCircle('red')">Baliw</button>
    <button class="choice" onclick="showCircle('blue')">Unggoy</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopiconelvlten";
    }
