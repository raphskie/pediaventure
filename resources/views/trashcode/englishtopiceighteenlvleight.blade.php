...
@section('title', 'Dipthongs | Level 8 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">WHAT WORD HAS A DIPTHONG "EEK"?
    </h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Peel</button>
    <button class="choice" onclick="showCircle('red')">Peed</button>
    V<button class="choice" onclick="showCircle('blue')">Peek</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopiceighteenlvlnine";
    }
