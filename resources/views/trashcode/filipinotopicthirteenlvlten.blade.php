...
@section('title', 'Pang-ukol | Antas 10 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ANO ANG IBIBIGAY MO PARA KAY JOSE?
    ALIN ANG NAGSASAAD NG PANG-UKOL SA PANGUNGUSAP?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">Para kay</button>
    <button class="choice" onclick="showCircle('red')">Ibibigay</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicthirteenlevels";
    }
