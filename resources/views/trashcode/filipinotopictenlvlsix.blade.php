...
@section('back-link', 'filipinotopictenlevels')
@section('title', 'Pang-uri | Antas 6 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ANG KALENDARYONG IYON AY MALAKI.
    ANO ANG NAGSASAAD NG PANG-URI SA PANGUNGUSAP?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">KALENDARYONG</button>
    <button class="choice" onclick="showCircle('red')">IYON</button>
    <button class="choice" onclick="showCircle('blue')">MALAKI</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopictenlvlseven";
    }
