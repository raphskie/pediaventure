...
@section('title', 'Pandiwa | Antas 6 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    SIYA AY GUMUGUHIT SA KANIYANG PAPEL.
  ...
  <div class="div-choices1">
    ...
    <button class="choice" onclick="showCircle('blue')">GUMUGUHIT</button>
    <button class="choice" onclick="showCircle('red')">PAPEL</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicninelvlseven";
    }
