...
@section('title', 'Time Measurement of Days, Weeks, Months, and Years | Level 2 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">HOW MANY DAYS DOES A SINGLE WEEK HAVE?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">9</button>
    <button class="choice" onclick="showCircle('red')">8</button>
    <button class="choice" onclick="showCircle('blue')">7</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicfifteenlvlthree";
    }
