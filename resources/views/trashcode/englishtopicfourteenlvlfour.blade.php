...
@section('title', 'Subject Verb Agreement and Verb Phrase | Level 4 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE CHEFS ARE COOKING IN THE KITCHEN.
    WHERE IS THE VERB IN THE SENTENCE?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">Cooking</button>
    <button class="choice" onclick="showCircle('red')">Kitchen</button>
    <button class="choice" onclick="showCircle('red')">The chefs</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicfourteenlvlfive";
    }
