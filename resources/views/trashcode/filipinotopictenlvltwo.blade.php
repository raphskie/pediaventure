...
@section('title', 'Pang-uri | Antas 2 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ANG SITIO NA ITO AY TAHIMIK.
    ANO ANG NAGSASAAD NG PANG-URI SA PANGUNGUSAP?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">TAHIMIK</button>
    <button class="choice" onclick="showCircle('red')">SITIO</button>
    <button class="choice" onclick="showCircle('red')">ITO</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopictenlvlthree";
    }
