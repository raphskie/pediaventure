...
@section('back-link', 'englishtopicfifteenlevels')
@section('title', 'Transitive and Intransitive Verb | Level 3 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">WE ARE READING OUR FAVORITE AUTHOR'S NEW BOOK.
    IDENTIFY IF THE SENTENCE IS TRANSITIVE OR INTRANSITIVE.</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">Transitive</button>
    <button class="choice" onclick="showCircle('red')">Intransitive</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicfifteenlvlfour";
    }
