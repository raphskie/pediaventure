...
@section('title', 'Capitalization of Words | Level 8 English | PEDIAVENTURE')
...
">
    ...
    ">The philippine eagle is Very well-known.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">The philippine eagle is very Well-known.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicseventeenlvlnine";
    }
