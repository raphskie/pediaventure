...
@section('title', 'Common Noun and Proper Noun | Level 2 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">WHAT DOES THE <u>FOX</u> SAY?
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicthreelvlthree";
    }
