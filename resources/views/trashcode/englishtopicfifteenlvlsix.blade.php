...
@section('title', 'Transitive and Intransitive Verb | Level 6 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">SHE IS GOING.
    IDENTIFY IF THE SENTENCE IS TRANSITIVE OR INTRANSITIVE.</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Transitive</button>
    <button class="choice" onclick="showCircle('blue')">Intransitive</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicfifteenlvlseven";
    }
