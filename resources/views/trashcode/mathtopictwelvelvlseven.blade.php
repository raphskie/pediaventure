...
@section('title', 'Identifying the Improper Fraction | Level 7 Math | PEDIAVENTURE')
...
@section('content')
  ...
  <div class="div-choices3 float1">
    <button class="balloon-choice" onclick="showCircle('red')">11/15</button>
    <button class="balloon-choice" onclick="showCircle('red')">14/26</button>
    <button class="balloon-choice" onclick="showCircle('blue')">32/30</button>
    <button class="balloon-choice" onclick="showCircle('red')">15/52</button>
    <button class="balloon-choice" onclick="showCircle('red')">41/46</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopictwelvelvleight";
    }
  </script>
