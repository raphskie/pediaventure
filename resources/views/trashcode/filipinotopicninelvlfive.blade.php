...
@section('title', 'Pandiwa | Antas 5 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ANG TATAY NI JOSE ANG NAGLILINIS NG KANIYANG KOTSE.
    ALIN SA PAGPILIAN ANG NAGSASAAD NG KILOS O GALAW?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">KOTSE</button>
    <button class="choice" onclick="showCircle('red')">JOSE</button>
    <button class="choice" onclick="showCircle('blue')">NAGLILINIS</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicninelvlsix";
    }
