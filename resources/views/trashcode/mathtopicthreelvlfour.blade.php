...
@section('title', 'Word Form of Numbers | Level 4 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    WHAT IS THE WORD FORM OF 230?</h1>
  </div>
...
">
    ...
    ">Two-hundred three zero</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Two-hundred thirty</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Two-hundred thirteen</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicthreelvlfive";
    }
