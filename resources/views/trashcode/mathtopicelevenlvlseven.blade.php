...
@section('title', 'Fractions | Level 7 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    <img class="fraction-img" src="http://127.0.0.1:8000/imgs/fractions/7.png">
  </div>

  <div class="div-choices3 float1">
    <button class="balloon-choice" onclick="showCircle('red')">2/10</button>
    <button class="balloon-choice" onclick="showCircle('blue')">2/15</button>
    <button class="balloon-choice" onclick="showCircle('red')">6/10</button>
    <button class="balloon-choice" onclick="showCircle('red')">3/12</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopicelevenlvleight";
    }
  </script>
