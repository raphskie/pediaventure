...
@section('title', 'Panghalip Pananong | Antas 10 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    KANINO TAYO MAKIKI-USAP SA MGA KAKLASE NATIN?
    ALIN SA PAGPILIAN ANG NAGSASAAD NG KATANUNGAN?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">NATIN</button>
    <button class="choice" onclick="showCircle('red')">KAKLASE</button>
    <button class="choice" onclick="showCircle('blue')">KANINO</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopiceightlevels";
    }
