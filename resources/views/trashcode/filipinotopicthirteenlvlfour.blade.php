...
@section('title', 'Pang-ukol | Antas 4 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ANG MGA ITIK AY NABIGYAN NG MGA PAGKAIN.
    ALIN ANG NAGSASAAD NG PANG-UKOL SA PANGUNGUSAP?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Nabigyan</button>
    <button class="choice" onclick="showCircle('red')">Itik</button>
    <button class="choice" onclick="showCircle('blue')">Ng mga</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicthirteenlvlfive";
    }
