...
@section('title', 'Compound Words | Level 2 English | PEDIAVENTURE')
...
">
    ...
    ">There are a lot of sunflowers at Burnham Park.</button>
    ...
    background: #c38543;
    border: solid 7px #57370a;
    ">Where is the mall located in this city?</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicsixlvlthree";
    }
