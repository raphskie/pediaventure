...
@section('back-link', 'filipinotopicsevenlevels')
@section('title', 'Panghalip Panao | Antas 5 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    LUBOS NA BINIGYAN <u>SIYA</u> NG MGA ROSAS SA KANYANG KAARAWAN.
    ANG NAKULAYANG SALITA AY NAGSASAAD NG...</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">ISAHAN</button>
    <button class="choice" onclick="showCircle('blue')">DALAWAHAN</button>
    <button class="choice" onclick="showCircle('red')">MARAMIHAN</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicsevenlvlsix";
    }
