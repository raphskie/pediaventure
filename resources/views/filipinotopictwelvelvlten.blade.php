...
@section('title', 'Kaantasan ng Pang-uri | Antas 10 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    SI DOKTOR JOSE RIZAL AY ISANG <u>NAPAKAHUSAY</u> NA MANUNULAT.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopictwelvelevels";
    }
