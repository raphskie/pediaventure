...
@section('title', 'Identifying the Standard Measurement | Level 8 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    WHAT MEASUREMENT TYPE IS USED ON MEASURING WATER?</h1>
  </div>
...
">
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicseventeenlvlnine";
    }
