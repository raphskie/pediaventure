...
@section('title', 'Pang-ukol | Antas 1 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    MULA SA AMING BAITANG, KAMI AY BUMABATI!
    ALIN ANG NAGSASAAD NG PANG-UKOL SA PANGUNGUSAP?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Bumabati</button>
    <button class="choice" onclick="showCircle('blue')">Kami</button>
    <button class="choice" onclick="showCircle('red')">Mula sa</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicthirteenlvltwo";
    }
