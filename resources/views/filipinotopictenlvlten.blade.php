...
@section('title', 'Pang-uri | Antas 10 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ANG BUNTOT NG PUSA AY MAHABA.
    ANO ANG NAGSASAAD NG PANG-URI SA PANGUNGUSAP?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">PUSA</button>
    <button class="choice" onclick="showCircle('red')">BUNTOT</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopictenlevels";
    }
