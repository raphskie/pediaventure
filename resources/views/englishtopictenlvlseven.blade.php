...
@section('title', 'Different Types of Sentences  | Level 7 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">PLEASE GO TO THE EMERGENCY ROOM IMMEDIATELY.
    </h1>
  </div>
  ...
  <div class="div-choices1">
    ...
    <button class="choice" onclick="showCircle('blue')">Imperative</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopictenlvleight";
    }
