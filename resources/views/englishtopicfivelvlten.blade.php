...
@section('back-link', 'englishtopicfivelevels')
@section('title', 'Synonyms and Antonyms | Level 10 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">What is the synonym of "scared"?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Tall</button>
    <button class="choice" onclick="showCircle('red')">Brave</button>
    <button class="choice" onclick="showCircle('blue')">Frightened</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicfivelevels";
    }
