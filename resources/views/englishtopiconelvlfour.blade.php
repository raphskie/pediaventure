...
@section('title', 'Nouns | Level 4 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE NAME OF THE DOG IS BROWNY.
  ...
  <div class="div-choices1">
    ...
    <button class="choice" onclick="showCircle('blue')">BROWNY</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopiconelvlfive";
    }
