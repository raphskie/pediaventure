...
@section('title', 'Identifying the Improper Fraction | Level 5 Math | PEDIAVENTURE')
...
@section('content')
  ...
  <div class="div-choices3 float1">
    <button class="balloon-choice" onclick="showCircle('blue')">6/3</button>
    ...
    <button class="balloon-choice" onclick="showCircle('red')">7/8</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopictwelvelvlsix";
    }
  </script>
