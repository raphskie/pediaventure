...
@section('title', 'Pangatnig | PEDIAVENTURE')
...
<div class="container-login" 
    ...
    <p class="p-tutorial">Para sa pag-aaral ng Kaantasan ng Pangatnig
        sa asignaturang Filipino, maaaring basahin ang katanungan sa itaas at piliin ang tamang sagot na nasa 
        ibaba nito.</p>

    <a href="filipinotopicfifteenlevels" class="home-log-reg" style="
        width: 46%;
        margin-left: auto;
        margin-right: auto;
    ">MAGPATULOY</a>   
