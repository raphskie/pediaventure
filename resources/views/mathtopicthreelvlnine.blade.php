...
@section('title', 'Word Form of Numbers | Level 9 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    WHAT IS THE WORD FORM OF 1,800?</h1>
  </div>
...
">
    ...
    ">One-thousand eighty</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">One-thousand eight</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">One-thousand eight-hundred</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicthreelvlten";
    }
