...
@section('title', 'Identifying Time | Level 10 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    <img class="fraction-img" src="http://127.0.0.1:8000/imgs/time/10.png">
  </div>

  <div class="div-choices3 float1">
    <button class="balloon-choice" onclick="showCircle('red')">7:10</button>
    <button class="balloon-choice" onclick="showCircle('red')">7:15</button>
    <button class="balloon-choice" onclick="showCircle('red')">7:30</button>
    <button class="balloon-choice" onclick="showCircle('red')">7:40</button>
    <button class="balloon-choice" onclick="showCircle('blue')">7:20</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopicthirteenlevels";
    }
  </script>
