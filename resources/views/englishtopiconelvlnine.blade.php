...
@section('title', 'Nouns | Level 9 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">HUNDRED ISLANDS IS ONE OF THE FAMOUS TOURIST SPOTS.
      WHICH OF THE FOLLOWING IS THE NOUN IN THE SENTENCE?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">FAMOUS</button>
    <button class="choice" onclick="showCircle('blue')">HUNDRED ISLANDS</button>
    <button class="choice" onclick="showCircle('red')">ONE</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopiconelvlten";
    }
