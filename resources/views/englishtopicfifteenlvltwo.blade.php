...
@section('title', 'Transitive and Intransitive Verb | Level 2 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">I TALK.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicfifteenlvlthree";
    }
