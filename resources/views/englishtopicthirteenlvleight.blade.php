...
@section('title', 'Order of Adjectives | Level 8 English | PEDIAVENTURE')
...
">
    ...
    ">The rectangular painting new looks beautiful.</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">The new rectangular painting looks beautiful.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">The painting rectangular new looks beautiful.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicthirteenlvlnine";
    }
