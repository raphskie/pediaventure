...
@section('title', 'Tambalang Salita | Antas 3 Filipino | PEDIAVENTURE')
...
">
    ...
    ">Siya ay umiinom ng tubig.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Ang kaniyang kinakain ay masarap.</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Ang akyat-bahay ay nahuli ng mga pulis.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicfourteenlvlfour";
    }
