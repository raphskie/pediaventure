...
@section('back-link', 'filipinotopicfifteenlevels')
@section('title', 'Pangatnig | Antas 9 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ALIN SA MGA PANGUNGUSAP ANG MAY PANGATNIG?</h1>
  </div>
...
">
    ...
    ">Si Jose at ang kanyang pamilya ay pupunta sa Maynila.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Ang mga larawan sa museo ay magaganda.</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Siya ay naglalakbay sa kagubatan ngunit ang kaniyang lalagyan ay nasira.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicfifteenlvlten";
    }
