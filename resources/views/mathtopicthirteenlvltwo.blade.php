...
@section('title', 'Identifying Time | Level 2 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    <img class="fraction-img" src="http://127.0.0.1:8000/imgs/time/2.png">
  </div>

  <div class="div-choices3 float1">
    <button class="balloon-choice" onclick="showCircle('red')">1:30</button>
    <button class="balloon-choice" onclick="showCircle('red')">6:25</button>
    <button class="balloon-choice" onclick="showCircle('red')">1:25</button>
    <button class="balloon-choice" onclick="showCircle('red')">6:00</button>
    <button class="balloon-choice" onclick="showCircle('blue')">2:00</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopicthirteenlvlthree";
    }
  </script>
