...
@section('title', 'Capitalization of Words | Level 1 English | PEDIAVENTURE')
...
">
    ...
    ">Mr. santos has been Going out lately.</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Those Samsung phones are displayed elegantly.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">A lot of Apple phones are being sold in america.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicseventeenlvltwo";
    }
