...
@section('title', 'Wastong Paggalang, Pagbati, Pakiki-usap, at Paghingi ng Paumanhin | Antas 10 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    IKAW AY KUMAKAUSAP SA IYONG MATALIK NA KAIBIGAN AT NAIS MONG KAMUSTAHIN ANG KANYANG INA.
    ALIN ANG WASTONG PANGUNGUSAP PARA DITO?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">ANO NA ULIT IYON?</button>
    <button class="choice" onclick="showCircle('red')">NAKAKATAWA NAMAN IYAN!</button>
    <button class="choice" onclick="showCircle('blue')">KAMUSTA NA PALA ANG IYONG NANAY?</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicsixlevels";
    }
