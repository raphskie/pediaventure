...
@section('title', 'Wastong Paggamit ng Dayalogo | Antas 8 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    font-size: 22px;
    font-weight: lighter;
">ANG IYONG MATALIK NA KAIBIGAN AY WALANG PAGKAIN AT SIYA'Y NAIS NA HUMINGI SA IYO.
  ...
  <div class="div-choices1" style="
    ...
    flex-wrap: wrap;
">
    <button class="choice2" onclick="showCircle('red')">AYAW KITANG BIGYAN!</button>
    <button class="choice2" onclick="showCircle('blue')">HETO, BIGYAN KITA NG PAGKAIN.</button>
    <button class="choice2" onclick="showCircle('red')">BAHALA KA SA BUHAY MO!</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicfourlvlnine";
    }
