...
@section('back-link', 'englishtopicsixteenlevels')
@section('title', 'Syllabicating Words | Level 10 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">HOW MANY SYLLABLES DOES <u>"VENTRILOQUIST"</u> HAVE?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">1</button>
    <button class="choice" onclick="showCircle('red')">2</button>
    <button class="choice" onclick="showCircle('red')">3</button>
    <button class="choice" onclick="showCircle('blue')">4</button>
    <button class="choice" onclick="showCircle('red')">5</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicsixteenlevels";
    }
