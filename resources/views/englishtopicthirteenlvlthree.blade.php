...
@section('title', 'Order of Adjectives | Level 3 English | PEDIAVENTURE')
...
">
    ...
    ">This small is fun party.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">This building has a clean big office.</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">The girl has a big red ribbon.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicthirteenlvlfour";
    }
