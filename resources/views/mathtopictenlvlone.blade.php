...
@section('title', 'Find the Quotient | Level 1 Math | PEDIAVENTURE')
...
@section('content')
  ...
  <div class="div-choices3 float1">
    <button class="balloon-choice" onclick="showCircle('blue')">1</button>
  ...
  <div class="div-choices3 float2">
    ...
    function nextLevel() {
      window.location.href = "mathtopictenlvltwo";
    }
  </script>
