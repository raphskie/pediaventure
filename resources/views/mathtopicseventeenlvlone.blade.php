...
@section('title', 'Identifying the Standard Measurement | Level 1 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    WHICH MEASUREMENT IS APPROPRIATE FOR MEASURING WEIGHT?</h1>
  </div>
...
">
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "mathtopicseventeenlvltwo";
    }
