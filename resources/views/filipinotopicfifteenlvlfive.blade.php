...
@section('title', 'Pangatnig | Antas 5 Filipino | PEDIAVENTURE')
...
">
    ...
    ">Ang mga kaklase ni Jose ay naglalaro.</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Siya ay nagtuturo bilang isang guro.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Sila ay naglilinis.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicfifteenlvlsix";
    }
