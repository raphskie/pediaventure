...
@section('title', 'Kaantasan ng Pang-uri | Antas 7 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ANG PAARALANG IYON AY <u>MAS MALAYO</u> KAYSA SA PAARALAN NA ITO.
    ALIN SA PAGPILIAN ANG NAGSASAAD NG NAKULAYANG SALITA?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Lantay</button>
    <button class="choice" onclick="showCircle('blue')">Pahambing</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopictwelvelvleight";
    }
