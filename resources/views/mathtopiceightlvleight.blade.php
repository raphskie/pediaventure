...
@section('title', 'Find the Product | Level 8 Math | PEDIAVENTURE')
...
@section('content')
  ...
  <div class="div-choices3 float1">
    <button class="balloon-choice" onclick="showCircle('red')">125</button>
    <button class="balloon-choice" onclick="showCircle('red')">161</button>
    <button class="balloon-choice" onclick="showCircle('red')">97</button>
  ...
  <div class="div-choices3 float2">
    ...
    <button class="balloon-choice" onclick="showCircle('red')">123</button>
    <button class="balloon-choice" onclick="showCircle('red')">262</button>
    <button class="balloon-choice" onclick="showCircle('blue')">160</button>
    <button class="balloon-choice" onclick="showCircle('red')">85</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopiceightlvlnine";
    }
  </script>
