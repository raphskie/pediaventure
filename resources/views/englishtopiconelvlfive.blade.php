...
@section('title', 'Nouns | Level 5 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">JOSE IS PLAYING WITH HIS FRIENDS AND SISTER.
  ...
  <div class="div-choices1">
    ...
    <button class="choice" onclick="showCircle('blue')">JOSE</button>
    <button class="choice" onclick="showCircle('red')">WITH</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopiconelvlsix";
    }
