...
@section('title', 'Identifying the Improper Fraction | Level 2 Math | PEDIAVENTURE')
...
@section('content')
  ...
  <div class="div-choices3 float1">
    ...
    <button class="balloon-choice" onclick="showCircle('red')">6/7</button>
    <button class="balloon-choice" onclick="showCircle('red')">6/9</button>
    <button class="balloon-choice" onclick="showCircle('blue')">9/8</button>
    <button class="balloon-choice" onclick="showCircle('red')">3/5</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopictwelvelvlthree";
    }
  </script>
