...
@section('title', 'Adjective  | Level 3 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">HE AND HIS DOG ARE HAPPY.
  ...
  <div class="div-choices1">
    ...
    <button class="choice" onclick="showCircle('red')">He</button>
    <button class="choice" onclick="showCircle('blue')">Happy</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicelevenlvlfour";
    }
