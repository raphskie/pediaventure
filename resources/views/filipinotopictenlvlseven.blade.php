...
@section('title', 'Pang-uri | Antas 7 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ANG KANIYANG PAGKAIN AY MATAMIS.
    ANO ANG NAGSASAAD NG PANG-URI SA PANGUNGUSAP?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">MATAMIS</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopictenlvleight";
    }
