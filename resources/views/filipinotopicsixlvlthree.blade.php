...
@section('title', 'Wastong Paggalang, Pagbati, Pakiki-usap, at Paghingi ng Paumanhin | Antas 3 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    IKAW AY TUMUTULONG SA IYONG TATAY NA MAGHANAP NG KANYANG HINAHANAP, NGUNIT NAKITA MO NA ANG BAGAY NA IYON.
    ALIN ANG WASTONG PANGUNGUSAP PARA DITO?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">HINDI KO NA MAHANAP.</button>
    <button class="choice" onclick="showCircle('blue')">ITAY, ETO NA PO ANG HINAHANAP NIYO.</button>
    <button class="choice" onclick="showCircle('red')">NASAAN NA NGA BA IYON?</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicsixlvlfour";
    }
