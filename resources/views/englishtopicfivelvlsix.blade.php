...
@section('title', 'Synonyms and Antonyms | Level 6 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">What is the synonym of "Small"?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Enormous</button>
    <button class="choice" onclick="showCircle('red')">Huge</button>
    <button class="choice" onclick="showCircle('blue')">Tiny</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicfivelvlseven";
    }
