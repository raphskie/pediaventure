...
@section('title', 'Adjective  | Level 2 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THOSE CARS ARE EXPENSIVE.
  ...
  <div class="div-choices1">
    ...
    <button class="choice" onclick="showCircle('blue')">Expensive</button>
    <button class="choice" onclick="showCircle('red')">Cars</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicelevenlvlthree";
    }
