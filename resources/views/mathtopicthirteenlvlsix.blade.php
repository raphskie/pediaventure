...
@section('title', 'Identifying Time | Level 6 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    <img class="fraction-img" src="http://127.0.0.1:8000/imgs/time/6.png">
  </div>

  <div class="div-choices3 float1">
    <button class="balloon-choice" onclick="showCircle('red')">11:10</button>
    <button class="balloon-choice" onclick="showCircle('red')">11:00</button>
    <button class="balloon-choice" onclick="showCircle('red')">4:45</button>
    <button class="balloon-choice" onclick="showCircle('blue')">11:15</button>
    <button class="balloon-choice" onclick="showCircle('red')">11:20</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopicthirteenlvlseven";
    }
  </script>
