...
@section('title', 'Mass Noun and Count Noun | Level 4 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE <u>SAND</u> CAN BE FORMED INTO ANY SHAPE.
      WHICH OF THE FOLLOWING THE COLORED WORD EXPRESSES?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">Mass Noun</button>
    <button class="choice" onclick="showCircle('red')">Count Noun</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopictwolvlfive";
    }
