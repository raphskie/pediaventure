...
@section('title', 'Order of Adjectives | Level 4 English | PEDIAVENTURE')
...
">
    ...
    ">She is drawing a red circle small.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">She is drawing a small circle red.</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">She is drawing a small red circle.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicthirteenlvlfive";
    }
