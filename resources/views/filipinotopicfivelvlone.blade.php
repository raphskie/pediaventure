...
@section('title', 'Pantangi at Pambalana | Antas 1 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    ANG KANIYANG <u>KWADERNO</u> NA VECO AY MAGANDA.
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicfivelvltwo";
    }
