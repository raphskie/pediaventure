...
@section('title', 'Order of Adjectives | Level 1 English | PEDIAVENTURE')
...
">
    ...
    ">She has a big black cat.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">There is a fox red small.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicthirteenlvltwo";
    }
