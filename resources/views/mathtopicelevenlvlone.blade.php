...
@section('title', 'Fractions | Level 1 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    <img class="fraction-img" src="http://127.0.0.1:8000/imgs/fractions/1.png">
  </div>

  <div class="div-choices3 float1">
    <button class="balloon-choice" onclick="showCircle('red')">1/3</button>
    <button class="balloon-choice" onclick="showCircle('red')">1/4</button>
    <button class="balloon-choice" onclick="showCircle('blue')">1/2</button>
    <button class="balloon-choice" onclick="showCircle('red')">1/5</button>
    <button class="balloon-choice" onclick="showCircle('red')">1/6</button>
    ...
    function nextLevel() {
      window.location.href = "mathtopicelevenlvltwo";
    }
  </script>
