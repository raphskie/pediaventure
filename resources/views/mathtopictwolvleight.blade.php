...
@section('title', 'Standard Forms | Level 8 Math | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">WHAT IS THE STANDARD FORM OF 100 + 100 + 100?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('blue')">300</button>
    <button class="choice" onclick="showCircle('red')">400</button>
    <button class="choice" onclick="showCircle('red')">500</button>
