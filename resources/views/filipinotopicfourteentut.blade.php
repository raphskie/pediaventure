...
@section('title', 'Tambalang Salita | PEDIAVENTURE')
...
<div class="container-login" 
    ...
    <p class="p-tutorial">Para sa pag-aaral ng Kaantasan ng Tambalang Salita
        sa asignaturang Filipino, maaaring basahin ang katanungan sa itaas at piliin ang tamang sagot na nasa 
        ibaba nito.</p>

    <a href="filipinotopicfourteenlevels" class="home-log-reg" style="
        width: 46%;
        margin-left: auto;
        margin-right: auto;
    ">MAGPATULOY</a>   
