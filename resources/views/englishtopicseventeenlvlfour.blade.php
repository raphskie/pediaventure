...
@section('title', 'Capitalization of Words | Level 4 English | PEDIAVENTURE')
...
">
    ...
    ">Some people Are going to batangas today.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">That painting is Named mona lisa.</button>
    <button class="choice2" onclick="showCircle('blue')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Her dog is named Brownie.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicseventeenlvlfive";
    }
