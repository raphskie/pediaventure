...
@section('title', 'Dipthongs | Level 5 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">WHAT WORD HAS A DIPTHONG "OOK"?
    </h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">Poke</button>
    <button class="choice" onclick="showCircle('red')">Tool</button>
    V<button class="choice" onclick="showCircle('blue')">Look</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopiceighteenlvlsix";
    }
