...
@section('title', 'Subject Verb Agreement and Verb Phrase | Level 9 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">THE CLOTHES ARE BEING CLEANED.
    WHERE IS THE VERB IN THE SENTENCE?</h1>
  </div>

  <div class="div-choices1">
    <button class="choice" onclick="showCircle('red')">The clothes</button>
    <button class="choice" onclick="showCircle('blue')">Being cleaned</button>
    <button class="choice" onclick="showCircle('red')">Are</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicfourteenlvlten";
    }
