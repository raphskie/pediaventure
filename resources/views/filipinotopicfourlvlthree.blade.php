...
@section('title', 'Wastong Paggamit ng Dayalogo | Antas 3 Filipino | PEDIAVENTURE')
...
<audio id="bgMusic" src="http://127.0.0.1:8000/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    font-size: 22px;
    font-weight: lighter;
">NAKITA MO ANG IYONG KAIBIGAN NA MATAGAL MO NANG HINDI NAKIKITA AT NAIS MONG KAMUSTAHIN. 
  ...
  <div class="div-choices1" style="
    ...
    flex-wrap: wrap;
">
    <button class="choice2" onclick="showCircle('red')">LUMAYO KA SA AKIN!</button>
    <button class="choice2" onclick="showCircle('blue')">KAMUSTA KA NA? MATAGAL NA TAYONG HINDI NAGKITA!</button>
    <button class="choice2" onclick="showCircle('red')">ANG IBON NA IYON AY MAGANDA.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicfourlvlfour";
    }
