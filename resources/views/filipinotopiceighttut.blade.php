...
@section('title', 'Panghalip Pananong | PEDIAVENTURE')
...
<div class="container-login" 
    ...
    <p class="p-tutorial">Para sa pag-aaral ng Panghalip Pananong
        sa asignaturang Filipino, maaaring basahin ang katanungan sa itaas at piliin ang tamang sagot na nasa 
        ibaba nito.</p>


    <a href="filipinotopiceightlevels" class="home-log-reg" style="
        width: 46%;
        margin-left: auto;
        margin-right: auto;
    ">MAGPATULOY</a>   
