...
@section('title', 'Synonyms and Antonyms | PEDIAVENTURE')
...
<div class="container-login" 
    ...
    <div class="topic-flex">    
        <p class="p-tutorial">You will be identifying the same meaning or the opposite meaning of the colored word in
