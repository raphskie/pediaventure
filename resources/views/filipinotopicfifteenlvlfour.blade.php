...
@section('title', 'Pangatnig | Antas 4 Filipino | PEDIAVENTURE')
...
">
    ...
    ">Ang pagong at ang kuneho ay nagkakarera.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Si Jose ay naglalakad pauwi.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Ang ilaw ay maliwanag.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicfifteenlvlfive";
    }
