...
@section('title', 'Tambalang Salita | Antas 6 Filipino | PEDIAVENTURE')
...
">
    ...
    ">Ang kaniyang aso ay mabagal na parang lakad-pagong.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Sila ay naglalaro sa bukid.</button>
    <button class="choice2" onclick="showCircle('red')" style="
    background: #c38543;
    border: solid 7px #57370a;
    ">Ang kanilang nalakad ay malayo.</button>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "filipinotopicfourteenlvlseven";
    }
