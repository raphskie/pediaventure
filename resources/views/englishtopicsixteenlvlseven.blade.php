...
@section('title', 'Syllabicating Words | Level 7 English | PEDIAVENTURE')
...
<audio id="bgMusic" src="/audios/spelling-bg1.mp3" autoplay="" loop=""></audio>
  ...
  <div class="instruction-container">
    ...
    <h1 class="h1-instruction">HOW MANY SYLLABLES DOES <u>"UNITED"</u> HAVE?</h1>
  </div>
  ...
  <script>
    ...
    function nextLevel() {
      window.location.href = "englishtopicsixteenlvleight";
    }
